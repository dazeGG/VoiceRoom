...
export const HISTORY_MODES: readonly ['latest', 'before', 'after', 'around'] = Object.freeze([
  'latest',
  'before',
  'after',
  'around'
...
export function normalizeHistoryEnvelope(
  value: unknown
):
...
export function buildHistoryEnvelope({
  mode = 'latest',
  messages = [],
  pageInfo = {}
}: {
