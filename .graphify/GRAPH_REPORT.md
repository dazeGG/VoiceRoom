...
## Corpus Check
- Large corpus: 783 files · ~380 977 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6300 nodes · 17637 edges · 235 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4734 · MODIFIES: 4415 · ON_BRANCH: 3620 · calls: 1938 · imports: 1154 · imports_from: 782 · PARENT_OF: 687 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 783 · Candidates: 863
- Excluded: 5 untracked · 46765 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `7c03069`
...
Cohesion: 0.02
Nodes (33): emojiAssetName(), emojiAssetUrl(), 2d36bc7 fix(api): bound messaging schema locks, 728cea2 feat: implement release 2.5.0 messaging platform (#105), ab373a6 chore(release): 2.5.0 (#121), cbaf1f5 Merge branch 'feature/2.5.0-fixes' into develop, { createDbPool }, createRelease250Pool() (+25 more)
...
Cohesion: 0.03
Nodes (49): AuthUser, playbackPolicy, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 20fdff5 feat(api): persist static rooms and chat (+41 more)
...
Cohesion: 0.03
Nodes (55): 1578df6 feat: add account settings, 208f295 feat(presence): add selectable account statuses, 22a796b Merge pull request #8 from feature/404-page, 3580978 fix(api): harden session and cookie write security, 4a8d9fc fix(api): address room persistence review findings, cc7f297 Merge pull request: chore private monitoring agent, ec9f802 feat(api): persist visual identity keys, ee1c6f6 feat(shared): add visual identity contracts (+47 more)
...
Cohesion: 0.06
Nodes (40): 1886650 feat(api): persist rooms and chat in postgres, 364b82c build(api): fence G15 predeploy migrations, 8fdccbd chore(scripts): default to docker compose workflows, a36adca chore(docker): add postgres compose workflows, path, readDatabaseConfig(), readEnvBool(), readMessageDeliveryMode() (+32 more)
...
Cohesion: 0.05
Nodes (38): createTestDatabase(), crypto, databaseName(), databaseUrlFor(), { Pool }, quoteIdent(), { readDatabaseConfig }, assert (+30 more)
...
Cohesion: 0.07
Nodes (36): 0ec8255 chore(release): bump version to 2.2.3, 2adaec0 Merge branch 'hotfix/2.2.3-ci', 3b6010b Merge branch 'release/2.2.2', 5fa984e Merge tag 'v2.2.2' into develop, bc6c32c Merge tag 'v2.2.3' into develop, cf119b8 fix(api): wait for fresh websocket summary frames, assert, cookieFrom() (+28 more)
...
Cohesion: 0.08
Nodes (37): 09c4d42 feat(shared): add the room shared-music wire contract, eb7ef3a fix(web): avoid cjs validation import in ssr, buildRoomRealtimeSummary(), buildServerEnvelope(), isPlainObject(), KNOWN_CLIENT_TYPES, { normalizeRoomId, normalizePeerId, normalizeSessionToken, cleanName }, normalizeTypingActivity() (+29 more)
...
Cohesion: 0.05
Nodes (30): createRoomStore(), assert, { createLinkPreviewRepository }, { createLinkPreviewStorage, reconcileLinkPreviewImages }, { createRoomStore }, { createTestDatabase }, { createUserStore }, crypto (+22 more)
...
Cohesion: 0.07
Nodes (24): PLURAL_VERB, SINGLE_VERB, TYPING_ACTIVITIES, TypingActivity, TypingEntry, TypingPerson, 8ffc3ac feat: show who is typing in direct messages and room chats, a0fa2d6 feat(api): drive room shared-music sessions (+16 more)
...
Cohesion: 0.07
Nodes (27): createDbPool(), { Pool }, { readDatabaseConfig }, { recordPgPoolError }, transaction(), recordPgPoolError(), { classifyPlatform, PLATFORM_CLASSES }, { createDbPool, transaction } (+19 more)
...
}, createAccountDeletionRepository(), crypto, PERSONAL_DATA_CLEANUP, { transaction }, { verifyPassword }, 3258210 docs: describe account deletion and its grace period, 78f51ae feat: delete an account with a seven-day grace period (+13 more)
...
Cohesion: 0.11
Nodes (14): 15e3ea9 Merge branch 'feature/account-sessions-recovery' into develop, 51b04d8 Merge branch 'feature/account-sessions-recovery' into develop, 8a43888 feat: split what's new from the recovery codes reminder, 9b710c5 feat(web): change the password from the security tab, ba511a8 docs: describe sign-in questions from new devices, cb75953 Merge branch 'feature/new-login-alerts' into develop, ffc3589 feat: ask the account about sign-ins from new devices, assert (+6 more)
...
Cohesion: 0.12
Nodes (28): 0b7bfc9 feat(web): add a desktop overlay for borderless games (#134), 3fa3f2e chore(release): back-merge 2.5.10 into develop, 929ba0d fix(web): desktop overlay avatars, custom games and idle opacity (#136), cad2af8 Merge pull request #137 from dazeGG/hotfix/2.5.10-backmerge, ec272fa feat(web): add a desktop overlay for borderless games (#134) (#135), edf009e feat(web): add desktop autostart settings, addDesktopOverlayGame(), DEFAULT_SETTINGS (+20 more)
...
Cohesion: 0.09
Nodes (21): readEnvInt(), abortError(), boundedBackoff(), createLeaseRuntime(), crypto, delay(), LeaseLostError, assert (+13 more)
...
Cohesion: 0.09
Nodes (18): 69b709a test(shared): correct platform DTO assertion, 88e8e93 test(release): define physical support matrix gate, b318c49 test(web): prove desktop root boundary, c4b1a22 test(api): enforce exact migration lock budget, edf6daf test(api): prove platform class migration, BLOCKED_ROUTES, classifyPlatform(), classifyPlatformPolicy() (+10 more)
...
Cohesion: 0.11
Nodes (15): 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, 88169aa fix(api): preserve migration history with corrective follow-ups, assert, BYTE_LIMIT_ROLLBACK_COUNT, { createAttachmentRepository }, { createTestDatabase }, crypto (+7 more)
...
Cohesion: 0.40
Nodes (3): WHATS_NEW_ITEMS, WhatsNewIcon, WhatsNewItem
...
## Knowledge Gaps
- **1760 isolated node(s):** `crypto`, `{ transaction }`, `{ verifyPassword }`, `{
  ACCOUNT_DELETION_GRACE_MS,
  DELETED_ACCOUNT_NAME,
  DELETED_LOGIN_PREFIX
}`, `PERSONAL_DATA_CLEANUP` (+1755 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 34`** (2 nodes): `13254ae docs: document durable room storage`, `c860746 feat(web): add static rooms and room chat UI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `3c617ec style(web): polish dm day separator`, `7db2783 docs(monitoring): align LiveKit track metric labels`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 202`** (2 nodes): `{ createDbPool }`, `createDmHistoryRepository()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (1 nodes): `LiveKitReconcileGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 208`** (2 nodes): `participantContextMenu`, `ParticipantMenuVariant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (1 nodes): `FakeServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 223`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (1 nodes): `e`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 229`** (2 nodes): `extensions`, `files`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (1 nodes): `MemoryStorage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `RuntimeConfigV1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `RealtimeRecoveryController` connect `Community 48` to `Community 10`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.05287820944681488 - nodes in this community are weakly interconnected._
...
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.023249299719887956 - nodes in this community are weakly interconnected._
