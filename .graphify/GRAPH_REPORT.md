...
## Corpus Check
- Large corpus: 803 files · ~394 500 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6453 nodes · 19250 edges · 247 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 4880 · contains: 4826 · MODIFIES: 4610 · calls: 1945 · imports: 1159 · imports_from: 787 · PARENT_OF: 736 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 803 · Candidates: 883
- Excluded: 0 untracked · 48320 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `6e1b80c`
...
Cohesion: 0.01
Nodes (186): createFriendStore(), createLinkPreviewRepository(), createDirectMessageRepository(), registerPinRoutes(), registerRoomHistoryRoutes(), createRoomMessageRepository(), registerNotificationRoutes(), {
...
Cohesion: 0.07
Nodes (157): develop, feature/2.6.0-prerelease, feature/composer-emoji-picker, feature/emoji-images, feature/whats-new-recovery-codes, feature/whats-new-screenshots, feature/whats-new-stories, fix/api-test-db-teardown (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.12
Nodes (164): backup/room-shared-music-pre-rebase, chore/graphify-refresh, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/account-sessions-recovery, feature/cd-pipeline, feature/desktop-app-settings, feature/docs-cleanup (+156 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (95): 08e3e13 Merge branch 'hotfix/2.2.1', 0ec8255 chore(release): bump version to 2.2.3, 17edd27 feat(web): add lobby voice controls widget, 2adaec0 Merge branch 'hotfix/2.2.3-ci', 397400d chore(release): bump version to 2.2.2, 3b6010b Merge branch 'release/2.2.2', 3ce55ad fix(web): dedupe self avatar and drop count label in room list, 3f83f05 Merge branch 'release/2.2.0' (+87 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (47): 2d36bc7 fix(api): bound messaging schema locks, 728cea2 feat: implement release 2.5.0 messaging platform (#105), 88169aa fix(api): preserve migration history with corrective follow-ups, ab373a6 chore(release): 2.5.0 (#121), BASELINE_CASES, createReplayTokenFixture(), runReplayScenario(), APPROVED_SHAPE (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (90): 7b8da98 feat(web): add the room music player, 9c3b5e4 feat(audio): add unified playback bus (#54), a0fa2d6 feat(api): drive room shared-music sessions, a0ff17a feat(web): improve sound settings with sliders and cue volume (#30), ca162ce build: ship music-bot as a published runtime image, ce89791 feat(web): add the room music player, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp, MicrophoneMode (+82 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (45): AuthUser, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 22a796b Merge pull request #8 from feature/404-page, 2b2c6c9 chore: release v2.0.0 (+37 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (89): 234177e feat(web): redesign screen source picker, 269978f chore(release): bump version to 2.2.6, 4c756b6 Merge branch 'release/2.2.6', 9ba8ece feat(web): tune screen share encoding, SCREEN_FPS_OPTIONS, SCREEN_QUALITY_OPTIONS, SCREEN_SIMULCAST_LAYER, SCREEN_STREAM_MODE_PROFILES (+81 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (42): 164b853 refactor(web): neutral input placeholders, dedicated dev port, desktop drag region (#16), 4be8312 chore: release v2.1.0, 551c869 chore: merge v2.1.0 back to develop, 5eef100 feat: friends, direct messages, and social lobby (#19), 65f8383 chore: removed status agent file, 67b668e chore: merge v2.0.2 back to develop, 8b5b175 chore: merge v2.0.1 back to develop, 9d9411c Merge pull request #10 from dazeGG/hotfix/api-docker-workspace-start (+34 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (74): 72d40ae fix(web): drop empty-room placeholder, auto-join guests, isRoomEmbedded(), RoomLifecycleSummary, applySpeaking(), attachMeter(), isLocalMicrophoneSpeaking(), isOverSpeakingThreshold(), refreshMicrophoneLevelMeterSoon() (+66 more)
...
Cohesion: 0.06
Nodes (66): main, 0112d02 fix(infra): pin livekit server version, 02824cd fix(web): surface friend request errors, 0753576 fix(web): show avatars in stream placeholders, 1718dc1 Bump version to 1.6.1, 1ddbd67 fix(web): show viewer avatars in stream badge, 2008ab4 feat(web): standardize interactive control sizing (#40), 21d8c5a fix(audit): harden room realtime and persistence (+58 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (39): SelectedMention, ReadReconciliationOptions, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 4553c35 fix(web): reconcile repeated cross-tab read cursors, 8e66057 fix(ci): fail release gates on wrong branch, b3732be fix(notifications): make inbox revisions monotonic, d8e3847 test(web): prove messaging reconciliation flows, fcd0beb fix(ci): bind OCI evidence to Actions archive bytes (+31 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (45): 177f5e3 test(api): prove durable message delivery, 93cad8e test(release): define G42 messaging checkpoint, fa382b2 fix(api): derive backlog age directly from storage, readEnvInt(), createNotificationOutboxRepository(), crypto, NotificationFenceError, createNotificationPushProvider() (+37 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (32): e0eb12c chore(release): prepare 2.4.0, reconcileAvatarStorage(), MascotIconProps, MascotVariant, AvatarAccentPresentation, AvatarAccentRgb, assert, { deriveAvatarAccent, dominantAvatarColor } (+24 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (33): AvatarCropDialogProps, AvatarCropShape, AvatarStackItem, AvatarStackProps, 049a913 fix(web): keep popover open on ambiguous focus loss, 08bd491 fix(web): focus DM compose input when opening a friend chat (#28), 0c20745 chore(release): back-merge 2.1.9, 206a214 refactor(web): use shared slider in settings controls (+25 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (48): 1886650 feat(api): persist rooms and chat in postgres, 8fdccbd chore(scripts): default to docker compose workflows, a36adca chore(docker): add postgres compose workflows, AVATAR_KEY_PATTERN, createAvatarStorage(), fs, path, { readUploadsDir } (+40 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (41): 40320f3 fix(release): authenticate oci evidence producers, 54086b4 fix(api): serialize notification retraction revisions, 6b3fc40 fix(release): require canonical merge commit authority, 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, transaction(), { createDbPool, transaction }, createMessageReadRepository() (+33 more)
...
Cohesion: 0.09
Nodes (55): e9dccb2 fix(web): recover remote microphone playback, detachRemoteAudioTrack(), applyRemoteScreenVideoDemand(), attachSubscribedRemoteScreenTrack(), attemptFreshLiveKitReplacement(), bindLiveKitRoomEvents(), clearAllScreenSubscriptionRetries(), clearScreenSubscriptionRetry() (+47 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (48): createPushStore(), assert, { createTestDatabase }, { createUserStore }, { LOGIN_ALERT_TTL_MS, LOGIN_FAMILIARITY_WINDOW_MS }, { runMigrations }, SILENT, test (+40 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (27): 043b73d chore: release v2.1.5, 1a5009b fix(web): remove transient voice-connecting placeholder, 4497e53 Merge branch 'release/2.2.5', 4e4ea97 fix(web): unify room tile grid layout, 564c893 feat(web): support centered nine-tile room layout, 56ebf7a docs: document root-scoped omx runtime usage, 6895206 fix(web): remove desktop app region from topbar, 8de78c2 Merge tag 'v2.2.5' into develop (+19 more)
...
Cohesion: 0.06
Nodes (47): cleanDisplayName(), errorMessage(), errorName(), getInitials(), hasLeadingZeroBits(), isCaptureCancelled(), isSafariBrowser(), stopStream() (+39 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (40): AccountSecurity, addRoomByCode(), authPost(), authRead(), AuthRequestError, avatarRequest(), changePassword(), confirmLoginAlert() (+32 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (38): playbackPolicy, 1578df6 feat: add account settings, 3580978 fix(api): harden session and cookie write security, c948bb7 feat(notifications): add do not disturb settings (#53), cc7f297 Merge pull request: chore private monitoring agent, fe15e8b chore: add private monitoring agent, { AVATAR_COLOR_KEYS, cleanAvatarColorKey, cleanPresenceStatus }, { createDbPool, transaction } (+30 more)
...
Cohesion: 0.04
Nodes (15): 0a0699b chore: release v2.1.2, 0f3d7a0 Merge branch 'hotfix/2.1.3', 0ffac54 feat(infra): expose livekit prometheus metrics for status stack (#22), 1840f18 chore: release v2.1.4, 2684b15 chore: release v2.1.3, 2994d09 fix(api): return friend request id from listRequests, 3b24424 fix(web): move download control to sidebar footer, 537a9a4 fix(web): auto-join room on direct load and reload (+7 more)
...
Cohesion: 0.06
Nodes (16): AvatarProps, BadgeProps, ButtonProps, 2391bbe feat(web): migrate UI icons to Lucide (#42), 3db468e feat(web): Volt redesign — landing, lobby v2, shared UI (#38), eb48d74 feat(web): adopt comfortaa and nunito typography, DialogProps, iconLg (+8 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (36): eventMatchesHotkey(), getDefaultHotkeyBinding(), getHotkeyStorageKey(), HotkeyAction, isTypingTarget(), parseHotkeyBinding(), readHotkeyBinding(), writeHotkeyBinding() (+28 more)
...
Cohesion: 0.12
Nodes (49): broadcastUserProfileToFriends(), buildSessionCookie(), checkAvatarUploadRate(), clearSessionCookie(), describeLoginDevice(), endAccountSessionConnections(), getAccountDeletionRepository(), getGeoLocator() (+41 more)
...
Cohesion: 0.08
Nodes (40): 09c4d42 feat(shared): add the room shared-music wire contract, 7dd4a5f refactor(rooms): replace visual presets with fallback avatars (#44), ee1c6f6 feat(shared): add visual identity contracts, buildRoomRealtimeSummary(), buildServerEnvelope(), isPlainObject(), KNOWN_CLIENT_TYPES, { normalizeRoomId, normalizePeerId, normalizeSessionToken, cleanName } (+32 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (30): 1709ead fix(api): centralize active room ban enforcement, 88e8e93 test(release): define physical support matrix gate, b318c49 test(web): prove desktop root boundary, c4b1a22 test(api): enforce exact migration lock budget, edf6daf test(api): prove platform class migration, BLOCKED_ROUTES, createActiveBanRepository(), crypto (+22 more)
...
Cohesion: 0.13
Nodes (38): applyRemoteScreenCue(), applyStreamViewerCue(), attachMeterSoon(), attachRemoteAudioTrack(), attachRemoteScreenStream(), attachRemoteTrack(), clearAllSpeaking(), clearRemoteScreenCue() (+30 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (31): createPeerId(), createSessionToken(), extractRoomId(), getRoomIdFromPath(), getStoredPeerSession(), rotateStoredPeerSession(), persistMicrophoneMode(), persistOutputMuted() (+23 more)
...
Cohesion: 0.10
Nodes (15): 01a206a chore: release v2.1.1, 0a9be62 fix(web): keep room preview chat closed by default (#32), 0d30394 chore: merge v2.1.1 back to develop, 0d74cad Merge branch 'release/2.1.6', 2eb2cbf chore: release v2.1.6, 3f9d416 wip: discord-style redesign (spaces/channels), 4125bf0 Add desktop shell layout styles for Electron., 5cc251a chore: release v2.1.7 (+7 more)
...
Cohesion: 0.10
Nodes (18): boundedText(), CLIENT_RULES, compareReleaseVersions(), formatRecoveryCode(), hasUnseenWhatsNew(), LOGIN_ALERT_KINDS, normalizeAccountSession(), normalizeLoginAlert() (+10 more)

### Community 79 - "Community 79"
Cohesion: 0.11
Nodes (11): 1dd8bdc feat(web): illustrate what is new with screenshots of the real app, 6e1b80c feat(web): add a recovery codes slide to what is new, 8ae4f7b Merge branch 'feature/whats-new-screenshots' into develop, c689e9e Merge branch 'feature/whats-new-stories' into develop, d67bd84 chore(graphify): rebuild the knowledge graph for the what's-new screenshots, WHATS_NEW_ITEMS, WHATS_NEW_SLIDES, WhatsNewIcon (+3 more)

### Community 80 - "Community 80"
Cohesion: 0.16
Nodes (17): containsPath(), createCoordinatedSnapshot(), filesBelow(), resolvedProspectivePath(), sha256(), 06b943b fix(ops): bind media restore catalog, 1332815 feat(ops): add coordinated media restore, a1d0d15 fix(restore): reject escaping snapshot sources (+9 more)
...
Cohesion: 0.12
Nodes (17): { buildServerEnvelope }, legacyPeerMessageToWs(), { buildRoomRealtimeSummaryFromLobbyRoom, createSummaryCoalescer }, { buildServerEnvelope, buildServerErrorEnvelope }, createRoomRealtimeRuntime(), { createTypingThrottle }, { createWsTransport }, { legacyPeerMessageToWs } (+9 more)
...
Cohesion: 0.19
Nodes (12): 28759aa fix(web): stack room reactions and keep the message toolbar reachable, 331bb32 fix(web): restore room panel interaction, 611153a test(web): anchor the DM polish e2e on the message row id, 647c18f fix(web): make chat replies jumpable and message identity clickable, 6baa520 Merge pull request #119 from dazeGG/feature/2.5.0-chat-polish, 732ab15 fix(api): keep room chat history instead of expiring it, 9a9f2ca fix(web): keep the reply target inside the composer field, a136dc0 fix(web): stabilize chat actions and overlays (+4 more)
...
Cohesion: 0.16
Nodes (11): df5ba40 feat(rooms): implement kick and ban moderation (#50), { buildServerEnvelope }, toWsAccountEvent(), { buildServerEnvelope, sendWsEnvelope }, { cleanPresenceStatus }, crypto, { toWsAccountEvent }, assert (+3 more)
...
Cohesion: 0.19
Nodes (10): createTypingThrottle(), { buildServerEnvelope, buildServerErrorEnvelope, parseInboundMessage }, { createTypingThrottle }, {
  normalizePeerId,
  normalizeRoomId,
  normalizeSessionToken
}, { normalizeTypingActivity }, assert, createClock(), { createTypingThrottle } (+2 more)
...
Cohesion: 0.33
Nodes (7): 2a61534 fix(api): stop the room read writing a column its table does not have, 69052e3 fix(web): flash the message a notification opens, as a reply jump does, ae660af Merge branch 'feature/2.5.0-fixes' into develop, c3cd163 fix: open a mention in its room's chat without joining voice, eab2b79 Merge branch 'feature/2.5.0-fixes' into develop, fa9a956 fix(api): bind read bounds as exact microseconds so the newest DM is read, webRoot
...
Cohesion: 0.50
Nodes (3): dismissToastUi(), invokeToastAction(), toastUi
...
- **Thin community `Community 38`** (1 nodes): `edf009e feat(web): add desktop autostart settings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (2 nodes): `ContextMenuContentState`, `ContextMenuProps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 184`** (1 nodes): `lang`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (2 nodes): `require`, `ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 213`** (1 nodes): `TestMediaStream`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (1 nodes): `LiveKitReconcileGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (2 nodes): `o`, `s()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 221`** (2 nodes): `participantContextMenu`, `ParticipantMenuVariant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 226`** (1 nodes): `FakeServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (2 nodes): `copyTextFor()`, `handleEmojiCopy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (1 nodes): `registerDmHistoryRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (1 nodes): `registerModerationRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 247`** (2 nodes): `extensions`, `files`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (2 nodes): `NAME_SITES`, `webRoot`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 249`** (1 nodes): `ComposerSelection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (2 nodes): `LinkPreview`, `LinkPreviewImage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 251`** (1 nodes): `webRoot`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 252`** (1 nodes): `webRoot`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 253`** (2 nodes): `VoiceRoom App Icon (Owl Mascot Mark on Dark Rounded Square)`, `VoiceRoom Mascot Mark (Masked Owl Silhouette, Transparent)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `ADR: Unicode authority for message reactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (1 nodes): `VoiceRoom 2.5 Architecture Boundaries`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 256`** (1 nodes): `Backlog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `config/capability-dag.v1.json`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (1 nodes): `Capability Readiness Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (1 nodes): `Design QA — reusable room and chat menus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `Font Assets README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `LiveKit External Auth-Gate Operations Doc (G05)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `VoiceRoom monitoring agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `OCI Runtime Publication Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `packages/CLAUDE.md Guidance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (1 nodes): `Production Digest Promotion Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 266`** (1 nodes): `Release 2.5.0 Repairs README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `RealtimeRecoveryController` connect `Community 51` to `Community 9`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AppRealtimeConnection` connect `Community 89` to `Community 64`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.010451505016722408 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.07291666666666667 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.12477576240781343 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02655466738924265 - nodes in this community are weakly interconnected._