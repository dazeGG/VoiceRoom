...
## Corpus Check
- Large corpus: 815 files · ~402 308 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6553 nodes · 20538 edges · 236 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 5791 · contains: 4888 · MODIFIES: 4831 · calls: 1971 · imports: 1182 · imports_from: 802 · PARENT_OF: 765 · method: 208 · re_exports: 59 · references: 23 · inherits: 11 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 815 · Candidates: 895
- Excluded: 0 untracked · 48476 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `2a41d55`
...
Cohesion: 0.09
Nodes (196): feature/2.6.0-prerelease, feature/composer-emoji-picker, feature/emoji-images, feature/guest-account-app-cta, feature/whats-new-recovery-codes, feature/whats-new-screenshots, feature/whats-new-stories, fix/api-test-db-teardown (+188 more)
...
Cohesion: 0.11
Nodes (174): backup/room-shared-music-pre-rebase, chore/graphify-refresh, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/account-sessions-recovery, feature/cd-pipeline, feature/desktop-app-settings, feature/docs-cleanup (+166 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (55): 2d36bc7 fix(api): bound messaging schema locks, 728cea2 feat: implement release 2.5.0 messaging platform (#105), 88169aa fix(api): preserve migration history with corrective follow-ups, ab373a6 chore(release): 2.5.0 (#121), BASELINE_CASES, createReplayTokenFixture(), runReplayScenario(), APPROVED_SHAPE (+47 more)
...
Cohesion: 0.03
Nodes (68): ComposerSelection, 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 5748635 Merge pull request #142 from dazeGG/release/2.6.0, 7524c15 feat(realtime): add websocket room updates, a0fa2d6 feat(api): drive room shared-music sessions, beffc4f Merge tag 'v2.2.0' into develop, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp (+60 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (93): 234177e feat(web): redesign screen source picker, 269978f chore(release): bump version to 2.2.6, 4c756b6 Merge branch 'release/2.2.6', 67827fd Merge branch 'release/2.2.7', 9ba8ece feat(web): tune screen share encoding, f5501ff Merge tag 'v2.2.6' into develop, NoiseModeOption, SCREEN_FPS_OPTIONS (+85 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (21): 01a206a chore: release v2.1.1, 0a0699b chore: release v2.1.2, 0d30394 chore: merge v2.1.1 back to develop, 0f3d7a0 Merge branch 'hotfix/2.1.3', 0ffac54 feat(infra): expose livekit prometheus metrics for status stack (#22), 1840f18 chore: release v2.1.4, 2684b15 chore: release v2.1.3, 2994d09 fix(api): return friend request id from listRequests (+13 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (43): AuthUser, SelfUserFlags, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 2b2c6c9 chore: release v2.0.0 (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (85): 72d40ae fix(web): drop empty-room placeholder, auto-join guests, bcdcd06 refactor(web): untangle room client import cycles, isRoomEmbedded(), extractRoomId(), RoomLifecycleSummary, hasLeadingZeroBits(), waitForUi(), applySpeaking() (+77 more)
...
Cohesion: 0.03
Nodes (58): 1578df6 feat: add account settings, 22a796b Merge pull request #8 from feature/404-page, 6cdbcca feat(api): remember desktop app use and the app prompt per account, 7d47c23 fix(web): preserve dev API proxy origin, c03d726 feat(web): refine room not-found page, cc7f297 Merge pull request: chore private monitoring agent, d2ae430 docs(web): document dev proxy origin contract, fe15e8b chore: add private monitoring agent (+50 more)
...
Cohesion: 0.05
Nodes (66): 5c8e7e1 Merge branch 'fix/ptt-idle-not-muted' into develop, 97d6dcd fix(web): stop showing idle push-to-talk as a muted microphone, a0c9ec4 chore(graphify): rebuild the knowledge graph for the push-to-talk fix, isMicrophoneShownMuted(), persistMicrophoneMode(), persistOutputMuted(), cleanDisplayName(), errorMessage() (+58 more)
...
Cohesion: 0.08
Nodes (74): authorizeRoomMutation(), broadcast(), broadcastRoomUpdate(), broadcastUserProfileToFriends(), buildSessionCookie(), checkAvatarUploadRate(), clearSessionCookie(), countRoomCreationQuotaRoomsForIp() (+66 more)
...
Cohesion: 0.04
Nodes (39): 043b73d chore: release v2.1.5, 0d74cad Merge branch 'release/2.1.6', 1a5009b fix(web): remove transient voice-connecting placeholder, 2c5f8d4 feat(web): show stream quality on tile thumbnails, 2ea67a2 Merge branch 'release/2.2.4', 2eb2cbf chore: release v2.1.6, 4125bf0 Add desktop shell layout styles for Electron., 4497e53 Merge branch 'release/2.2.5' (+31 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (37): AvatarCropDialogProps, AvatarCropShape, AvatarStackItem, AvatarStackProps, 049a913 fix(web): keep popover open on ambiguous focus loss, 08bd491 fix(web): focus DM compose input when opening a friend chat (#28), 0a9be62 fix(web): keep room preview chat closed by default (#32), 0c20745 chore(release): back-merge 2.1.9 (+29 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (55): createPushStore(), assert, { createTestDatabase }, { createUserStore }, { LOGIN_ALERT_TTL_MS, LOGIN_FAMILIARITY_WINDOW_MS }, { runMigrations }, SILENT, test (+47 more)
...
Cohesion: 0.05
Nodes (46): c928af9 fix(api): require exact migration catalog readiness, d02ad7f fix(release): resolve evidence from immutable external artifacts, acquireMigrationLock(), advisoryLockParts(), assertMigrationLockHeld(), assertMigrationReady(), assertNoDirtyMigrationState(), { Client } (+38 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (43): AccountSecurity, addRoomByCode(), authPost(), authRead(), AuthRequestError, avatarRequest(), changePassword(), confirmLoginAlert() (+35 more)
...
Cohesion: 0.08
Nodes (50): clampStreamVolume(), getStoredStreamVolume(), normalizeStoredStreamVolume(), storeStreamVolume(), Participant, clearScreenAttendance(), setScreenAttendance(), releaseScreenMediaElement() (+42 more)
...
Cohesion: 0.05
Nodes (25): SelectedMention, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 5459a43 feat(platform): harden G13 runtime configuration edge, d8e3847 test(web): prove messaging reconciliation flows, ecc157a refactor(web): preserve async failure evidence, desktop, router, sw (+17 more)
...
Cohesion: 0.06
Nodes (24): 164b853 refactor(web): neutral input placeholders, dedicated dev port, desktop drag region (#16), 2a41d55 feat(web): ask guests for an account and browser users for the desktop app, 65f8383 chore: removed status agent file, 67b668e chore: merge v2.0.2 back to develop, 7b8da98 feat(web): add the room music player, b3728e3 feat: add guest name modal for room entry, b48e553 chore: release v2.0.2, c860746 feat(web): add static rooms and room chat UI (+16 more)
...
Cohesion: 0.06
Nodes (25): DesktopAsset, DesktopRelease, fetchDesktopRelease(), 1718dc1 Bump version to 1.6.1, 2600ae8 Merge pull request #3 from dazeGG/fix/output-mute-unsubscribe, 634b607 feat(web): prepare Voice Room 1.7.0, d101bf6 feat(ui): screen view polish, stream tiles, and Phosphor icons (#4), createProofOfWork() (+17 more)
...
Cohesion: 0.06
Nodes (10): 4be8312 chore: release v2.1.0, 551c869 chore: merge v2.1.0 back to develop, 5eef100 feat: friends, direct messages, and social lobby (#19), b503e28 chore: merge release/2.1.0 into main, NOISE_MODE_SELECT_OPTIONS, roomDeviceUi, roomSettingsUi, ControlHandler (+2 more)
...
Cohesion: 0.06
Nodes (30): a1a3fe3 feat(shared): share the desktop app rule and self-only account flags, boundedText(), CLIENT_RULES, compareReleaseVersions(), AccountDeletionPreview, AccountDeletionRoom, AccountSession, LoginAlert (+22 more)
...
Cohesion: 0.08
Nodes (39): develop, 0043b03 build: ship music-bot as a published runtime image, 0112d02 fix(infra): pin livekit server version, 02824cd fix(web): surface friend request errors, 07e362c chore(omx): update model routing, 2008ab4 feat(web): standardize interactive control sizing (#40), 21d8c5a fix(audit): harden room realtime and persistence, 3919068 feat(web): add source quality for original resolution screen sharing and per-mode adapt profiles (+31 more)
...
Cohesion: 0.10
Nodes (23): RoomSnapshot, 50f75e7 Merge branch 'release/2.2.8', 81b047c Merge tag 'v2.2.8' into develop, 8482221 chore(release): bump version to 2.2.8, d8f8e01 fix(realtime): restore room updates after reconnect, acknowledgeActiveVoiceResync(), clearActiveResync(), detailHandlers (+15 more)
...
Cohesion: 0.14
Nodes (18): applyRegistrationResult(), bindDesktopGlobalHotkeys(), deliverDesktopAction(), DesktopActionHandler, DesktopGlobalHotkeyAction, DesktopGlobalHotkeyPhase, desktopGlobalHotkeysAvailable(), DesktopHotkeyFailure (+10 more)
...
Cohesion: 0.15
Nodes (17): closePeer(), getCredentialBoundary(), getLiveKitConfig(), getLiveKitCredentialProvider(), getLiveKitHttpUrl(), getLiveKitRoomName(), handleLiveKitToken(), publicPeer() (+9 more)
...
Cohesion: 0.18
Nodes (8): assert, { createFriendStore, orderedPair }, { createTestDatabase }, { createUserStore }, crypto, { runMigrations }, SILENT, test
...
Cohesion: 0.28
Nodes (6): AppPromptInput, resolveRoomCta(), RoomCtaInput, RoomCtaKind, shouldOpenAppPrompt(), webRoot
...
Cohesion: 0.33
Nodes (6): 0753576 fix(web): show avatars in stream placeholders, 1ddbd67 fix(web): show viewer avatars in stream badge, 5b54d09 fix(web): remove viewer label from stream badge, 6ea473b docs: add git flow workflow, 73f12ba docs: default to ready pull requests, b944a1b Revert "fix(web): show avatars in stream placeholders"
...
## Knowledge Gaps
- **1806 isolated node(s):** `crypto`, `{ transaction }`, `{ verifyPassword }`, `{
  ACCOUNT_DELETION_GRACE_MS,
  DELETED_ACCOUNT_NAME,
  DELETED_LOGIN_PREFIX
}`, `PERSONAL_DATA_CLEANUP` (+1801 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 155`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 173`** (1 nodes): `lang`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 202`** (2 nodes): `require`, `ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (1 nodes): `TestMediaStream`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 228`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 234`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (2 nodes): `copyTextFor()`, `handleEmojiCopy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 240`** (1 nodes): `registerModerationRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (2 nodes): `VoiceRoom App Icon (Owl Mascot Mark on Dark Rounded Square)`, `VoiceRoom Mascot Mark (Masked Owl Silhouette, Transparent)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 243`** (1 nodes): `ADR: Unicode authority for message reactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (1 nodes): `VoiceRoom 2.5 Architecture Boundaries`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (1 nodes): `Backlog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (1 nodes): `config/capability-dag.v1.json`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 247`** (1 nodes): `Capability Readiness Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (1 nodes): `Design QA — reusable room and chat menus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 249`** (1 nodes): `Font Assets README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (1 nodes): `LiveKit External Auth-Gate Operations Doc (G05)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 251`** (1 nodes): `VoiceRoom monitoring agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 252`** (1 nodes): `OCI Runtime Publication Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 253`** (1 nodes): `packages/CLAUDE.md Guidance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `Production Digest Promotion Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (1 nodes): `Release 2.5.0 Repairs README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `AppRealtimeConnection` connect `Community 89` to `Community 66`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.08753968253968254 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.010381403746332656 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.11212914485165794 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021459694989106753 - nodes in this community are weakly interconnected._