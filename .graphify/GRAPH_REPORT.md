...
## Corpus Check
- Large corpus: 805 files · ~396 856 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6484 nodes · 20198 edges · 238 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 5588 · contains: 4836 · MODIFIES: 4796 · calls: 1951 · imports: 1166 · imports_from: 795 · PARENT_OF: 759 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1
...
- Excluded: 0 untracked · 48444 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `873c452`
...
Cohesion: 0.09
Nodes (177): feature/2.6.0-prerelease, feature/composer-emoji-picker, feature/emoji-images, feature/whats-new-recovery-codes, feature/whats-new-screenshots, feature/whats-new-stories, fix/api-test-db-teardown, fix/open-in-app-download (+169 more)
...
Cohesion: 0.13
Nodes (165): backup/room-shared-music-pre-rebase, chore/graphify-refresh, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/account-sessions-recovery, feature/cd-pipeline, feature/desktop-app-settings, feature/docs-cleanup (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (131): 234177e feat(web): redesign screen source picker, 269978f chore(release): bump version to 2.2.6, 4c756b6 Merge branch 'release/2.2.6', 66d2bdd feat(web): apply screen profile via desktop capture bridge, 67827fd Merge branch 'release/2.2.7', 91c57c5 fix(web): truncate long room names in lobby, 9ba8ece feat(web): tune screen share encoding, bd9bc6c feat(web): add native capture stats to screen share monitoring (+123 more)
...
Cohesion: 0.04
Nodes (79): 72d40ae fix(web): drop empty-room placeholder, auto-join guests, isRoomEmbedded(), createPeerId(), createSessionToken(), extractRoomId(), getRoomIdFromPath(), getStoredPeerSession(), rotateStoredPeerSession() (+71 more)
...
Cohesion: 0.05
Nodes (66): bcdcd06 refactor(web): untangle room client import cycles, dbToAmplitude(), persistMicrophoneVolume(), MicProcessor, MicrophoneCapture, RoomLifecycleSummary, disconnectAudioNode(), applySpeaking() (+58 more)
...
Cohesion: 0.04
Nodes (38): 043b73d chore: release v2.1.5, 0d74cad Merge branch 'release/2.1.6', 1a5009b fix(web): remove transient voice-connecting placeholder, 2c5f8d4 feat(web): show stream quality on tile thumbnails, 2ea67a2 Merge branch 'release/2.2.4', 2eb2cbf chore: release v2.1.6, 4125bf0 Add desktop shell layout styles for Electron., 4497e53 Merge branch 'release/2.2.5' (+30 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (40): 0753576 fix(web): show avatars in stream placeholders, 1ddbd67 fix(web): show viewer avatars in stream badge, 28759aa fix(web): stack room reactions and keep the message toolbar reachable, 2ce6059 test(shared): lock attachment contracts, 331bb32 fix(web): restore room panel interaction, 5137885 fix(api): guard room removal and muted joins, 5b54d09 fix(web): remove viewer label from stream badge, 611153a test(web): anchor the DM polish e2e on the message row id (+32 more)
...
Cohesion: 0.08
Nodes (42): 09c4d42 feat(shared): add the room shared-music wire contract, 6eb964c feat(shared): add the room shared-music wire contract, 7dd4a5f refactor(rooms): replace visual presets with fallback avatars (#44), eb7ef3a fix(web): avoid cjs validation import in ssr, ee1c6f6 feat(shared): add visual identity contracts, buildRoomRealtimeSummary(), buildServerEnvelope(), isPlainObject() (+34 more)
...
Cohesion: 0.07
Nodes (37): 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 7524c15 feat(realtime): add websocket room updates, beffc4f Merge tag 'v2.2.0' into develop, df5ba40 feat(rooms): implement kick and ban moderation (#50), { buildServerEnvelope }, toWsAccountEvent(), {
  parseClientEnvelope,
  buildServerEnvelope,
...
Cohesion: 0.06
Nodes (24): del(), fetchJson(), patchJson(), postJson(), postJsonAuth(), putJson(), createRoomProof(), hasLeadingZeroBits() (+16 more)
...
Cohesion: 0.06
Nodes (19): 164b853 refactor(web): neutral input placeholders, dedicated dev port, desktop drag region (#16), 22a796b Merge pull request #8 from feature/404-page, 4be8312 chore: release v2.1.0, 551c869 chore: merge v2.1.0 back to develop, 5eef100 feat: friends, direct messages, and social lobby (#19), 65f8383 chore: removed status agent file, 67b668e chore: merge v2.0.2 back to develop, 7d47c23 fix(web): preserve dev API proxy origin (+11 more)
...
Cohesion: 0.08
Nodes (19): b120355 feat(release): complete 2.4.0 plan (#55), eventMatchesHotkey(), getDefaultHotkeyBinding(), getHotkeyStorageKey(), HotkeyAction, isTypingTarget(), parseHotkeyBinding(), readHotkeyBinding() (+11 more)
...
Cohesion: 0.07
Nodes (15): DesktopAsset, DesktopRelease, 1718dc1 Bump version to 1.6.1, 2600ae8 Merge pull request #3 from dazeGG/fix/output-mute-unsubscribe, 634b607 feat(web): prepare Voice Room 1.7.0, d101bf6 feat(ui): screen view polish, stream tiles, and Phosphor icons (#4), DESKTOP_BUILDS, DesktopBuild (+7 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (27): 5c8e7e1 Merge branch 'fix/ptt-idle-not-muted' into develop, 873c452 fix(web): offer the desktop download on the open-in-app screen, 97d6dcd fix(web): stop showing idle push-to-talk as a muted microphone, a0c9ec4 chore(graphify): rebuild the knowledge graph for the push-to-talk fix, isMicrophoneShownMuted(), persistMicrophoneMode(), persistOutputMuted(), playOutputCue() (+19 more)
...
Cohesion: 0.07
Nodes (28): 50f75e7 Merge branch 'release/2.2.8', 81b047c Merge tag 'v2.2.8' into develop, 8482221 chore(release): bump version to 2.2.8, a0fa2d6 feat(api): drive room shared-music sessions, d523ff1 chore(release): back-merge 2.6.0 into develop, d8f8e01 fix(realtime): restore room updates after reconnect, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp, parseInboundMessage() (+20 more)
...
Cohesion: 0.07
Nodes (6): 2391bbe feat(web): migrate UI icons to Lucide (#42), 89decba feat(web): improve active voice widget with room visual and leave cue, iconLg, iconMd, iconSm, iconXs
...
Cohesion: 0.11
Nodes (30): develop, 0112d02 fix(infra): pin livekit server version, 02824cd fix(web): surface friend request errors, 07e362c chore(omx): update model routing, 2008ab4 feat(web): standardize interactive control sizing (#40), 2bb7a79 Merge branch 'fix/desktop-autostart-test-vite' into develop, 3919068 feat(web): add source quality for original resolution screen sharing and per-mode adapt profiles, 5566e1c fix(web): sync room entry session (+22 more)
...
Cohesion: 0.14
Nodes (21): deletePushSubscription(), fetchPushConfig(), savePushSubscription(), decodeVapidKey(), detachPushSubscription(), getRegistration(), isDesktopRuntime(), isPushSuppressedByPlatform() (+13 more)
...
Cohesion: 0.12
Nodes (20): applyRegistrationResult(), bindDesktopGlobalHotkeys(), deliverDesktopAction(), DesktopActionHandler, DesktopGlobalHotkeyAction, DesktopGlobalHotkeyPhase, desktopGlobalHotkeysAvailable(), DesktopHotkeyFailure (+12 more)
...
Cohesion: 0.31
Nodes (8): 2a61534 fix(api): stop the room read writing a column its table does not have, 69052e3 fix(web): flash the message a notification opens, as a reply jump does, ae660af Merge branch 'feature/2.5.0-fixes' into develop, c3cd163 fix: open a mention in its room's chat without joining voice, eab2b79 Merge branch 'feature/2.5.0-fixes' into develop, fa9a956 fix(api): bind read bounds as exact microseconds so the newest DM is read, { createDbPool, transaction }, webRoot
...
Cohesion: 0.25
Nodes (6): WHATS_NEW_ITEMS, WHATS_NEW_SLIDES, WhatsNewIcon, WhatsNewItem, WhatsNewSceneId, WhatsNewSlide
...
- **Thin community `Community 159`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 188`** (1 nodes): `lang`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (2 nodes): `require`, `ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 237`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `registerDmHistoryRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `RealtimeRecoveryController` connect `Community 51` to `Community 7`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AppRealtimeConnection` connect `Community 94` to `Community 71`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.0898175507715398 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.010576644450883802 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.13038635572572224 - nodes in this community are weakly interconnected._
