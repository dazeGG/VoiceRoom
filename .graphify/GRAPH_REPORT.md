...
Cohesion: 0.01
Nodes (174): createFriendStore(), createMessageReadRepository(), { assertMigrationReady, runMigrations }, attachFastifyRequestBody(), AUTH_RATE_LIMIT, AUTH_RATE_WINDOW_MS, authLimiter, AVATAR_UPLOAD_RATE_LIMIT (+166 more)

### Community 1 - "Community 1"
Cohesion: 0.10
Nodes (120): feature/2.5.0-to-rc, feature/cd-pipeline, feature/docs-cleanup, feature/room-shared-music, hotfix/room-membership-backfill, release/2.5.0, 0043b03 build: ship music-bot as a published runtime image, 01f4965 fix(livekit): unblock browser room joins (+112 more)
...
Cohesion: 0.03
Nodes (52): 05f2a77 test(api): bind strict credential cutover, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 501ef14 test(web): lock leave and rejoin flow, 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, 849600b fix(api): persist membership after admission, 88169aa fix(api): preserve migration history with corrective follow-ups, d9f484d test(engagement): prove content and mention UoW (+44 more)
...
Cohesion: 0.06
Nodes (33): RoomRealtimeSummary, RoomPeer, AvatarStackItem, AvatarStackProps, 0c20745 chore(release): back-merge 2.1.9, 46cb450 feat(web): extend shared slider customization, 98e9f11 chore(release): merge 2.1.9, 98f910e Merge branch 'release/2.1.7' (+25 more)
...
Cohesion: 0.06
Nodes (39): emojiAssetName(), emojiAssetUrl(), isToneIndex(), loadSkinTone(), saveSkinTone(), SkinToneIndex, 42e581f feat(web): draw reactions from bundled artwork and rebuild the picker, 7609180 fix(web): harden reaction convergence (+31 more)
...
Cohesion: 0.06
Nodes (15): accessibleName(), assertAccessibleName(), assertFocusOrder(), assertKeyboardActivation(), assertLiveRegion(), assertReducedMotionEnabled(), assertStableLayout(), text() (+7 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (33): b16c894 fix(api): expose fail-closed release telemetry, fa382b2 fix(api): derive backlog age directly from storage, createNotificationOutboxRepository(), crypto, NotificationFenceError, createNotificationPushProvider(), assert, {createInboxRepository} (+25 more)
...
Cohesion: 0.06
Nodes (36): containsPath(), createCoordinatedSnapshot(), filesBelow(), resolvedProspectivePath(), sha256(), 06b943b fix(ops): bind media restore catalog, 1332815 feat(ops): add coordinated media restore, 2350242 build(api): define expiry-aware rescue profile (+28 more)

### Community 32 - "Community 32"
Cohesion: 0.10
Nodes (41): develop, 0580b9c Merge branch 'feature/cd-pipeline' into develop, 0f0c04b fix(web): align popover trigger inside chat action toolbars, 1fa0876 docs: remove shipped release plans and stale notes, 2697cfb chore(graphify): rebuild the code graph for the deploy pipeline, 28759aa fix(web): stack room reactions and keep the message toolbar reachable, 35e092e fix(ci): run the whole deploy script and fail rollouts that stop early, 368168c test(api): cover the LiveKit gate's dead-socket branches (+33 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (37): 01e9d33 feat(room): add side panel participant roster, 0753576 fix(web): show avatars in stream placeholders, 08bd491 fix(web): focus DM compose input when opening a friend chat (#28), 0a9be62 fix(web): keep room preview chat closed by default (#32), 1ddbd67 fix(web): show viewer avatars in stream badge, 2ce6059 test(shared): lock attachment contracts, 331bb32 fix(web): restore room panel interaction, 3940c26 fix(web): preserve friend online status across realtime race (#27) (+29 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (24): 0a0699b chore: release v2.1.2, 0d30394 chore: merge v2.1.1 back to develop, 0d74cad Merge branch 'release/2.1.6', 0f3d7a0 Merge branch 'hotfix/2.1.3', 0ffac54 feat(infra): expose livekit prometheus metrics for status stack (#22), 1840f18 chore: release v2.1.4, 2684b15 chore: release v2.1.3, 2994d09 fix(api): return friend request id from listRequests (+16 more)
...
Cohesion: 0.07
Nodes (26): createDbPool(), { Pool }, { readDatabaseConfig }, { recordPgPoolError }, transaction(), { classifyPlatform, PLATFORM_CLASSES }, { createDbPool, transaction }, createPushStore() (+18 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (29): ac1c7f4 fix(api): allow safe guest reaction reads, ad596da test(api): prove reaction persistence invariants, d43fd78 fix(shared): accept signed reactor cursors, assertReactionEmoji(), cleanReactionEmoji(), EMOJI_REACTION_AUTHORITY, buildGroups(), GROUP_ANCHORS (+21 more)
...
Cohesion: 0.08
Nodes (25): 10de220 test(api): prove active ban expiry in PostgreSQL, 177f5e3 test(api): prove durable message delivery, 2d8eac5 test(messaging): lock G20-G23 contracts, 93cad8e test(release): define G42 messaging checkpoint, cb7ad0e feat(api): fence message delivery cutover, abortError(), boundedBackoff(), createLeaseRuntime() (+17 more)
...
Cohesion: 0.11
Nodes (7): c80ed8a feat(web): expand contextual menus, ProfileCardAnchor, profileCardUi, ProfileCardPerson, ProfileCardProps, ProfileCardRelationship, root
...
Cohesion: 0.13
Nodes (7): ReadReconciliationOptions, 4553c35 fix(web): reconcile repeated cross-tab read cursors, d8e3847 test(web): prove messaging reconciliation flows, FakeBroadcastChannel, loadMessagingModule(), require, ts
...
Cohesion: 0.13
Nodes (12): c3cd163 fix: open a mention in its room's chat without joining voice, eab2b79 Merge branch 'feature/2.5.0-fixes' into develop, NotificationInboxTransport, NotificationEnvelope, NotificationItem, NotificationLevel, NotificationReason, webRoot (+4 more)
...
Cohesion: 0.13
Nodes (16): createMediaStorage(), createStorageKey(), crypto, fs, parseStorageKey(), path, STORAGE_KEY_PATTERN, validateAttachmentId() (+8 more)
...
Cohesion: 0.18
Nodes (9): 0fbf930 fix(web): polish avatar and chat controls, 451844b feat(web): refine lobby and room settings, 74d4ec7 fix(web): defer audio unlock to stream gesture, 8e4a907 docs(release): add 2.4.0 implementation plan, b3efade fix(api): sync profile updates with friends, root, addOrigin(), config (+1 more)
...
- **Thin community `Community 124`** (2 nodes): `ContextMenuContentState`, `ContextMenuProps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `require`, `ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
