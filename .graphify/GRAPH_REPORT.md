...
## Corpus Check
- Large corpus: 800 files · ~392 285 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6446 nodes · 18822 edges · 231 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4826 · MODIFIES: 4598 · ON_BRANCH: 4472 · calls: 1945 · imports: 1159 · imports_from: 787 · PARENT_OF: 728 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 800 · Candidates: 880
- Excluded: 0 untracked · 48111 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `a7a06b6`
...
Cohesion: 0.06
Nodes (357): backup/room-shared-music-pre-rebase, chore/graphify-refresh, develop, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/2.6.0-prerelease, feature/account-sessions-recovery, feature/cd-pipeline (+349 more)
...
Cohesion: 0.03
Nodes (55): AvatarProps, AvatarCropDialogProps, AvatarCropShape, AvatarStackItem, AvatarStackProps, BadgeProps, ButtonProps, 049a913 fix(web): keep popover open on ambiguous focus loss (+47 more)
...
Cohesion: 0.03
Nodes (31): 043b73d chore: release v2.1.5, 2391bbe feat(web): migrate UI icons to Lucide (#42), 2ea67a2 Merge branch 'release/2.2.4', 4497e53 Merge branch 'release/2.2.5', 4e4ea97 fix(web): unify room tile grid layout, 6c02eed feat(web): draw emoji in names and room names as artwork, 8de78c2 Merge tag 'v2.2.5' into develop, 9976dab Merge tag 'v2.1.5' into develop (+23 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (79): 9c3b5e4 feat(audio): add unified playback bus (#54), MicrophoneMode, NOISE_MODES, NoiseMode, amplitudeToDb(), clampGateThresholdDb(), clampParticipantVolume(), DEFAULT_PARTICIPANT_AUDIO_PREFERENCE (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (41): AccountSecurity, 15e3ea9 Merge branch 'feature/account-sessions-recovery' into develop, 51b04d8 Merge branch 'feature/account-sessions-recovery' into develop, 78f51ae feat: delete an account with a seven-day grace period, 8a43888 feat: split what's new from the recovery codes reminder, 9b710c5 feat(web): change the password from the security tab, cb75953 Merge branch 'feature/new-login-alerts' into develop, e088f03 Merge branch 'feature/account-deletion' into develop (+33 more)
...
Cohesion: 0.03
Nodes (34): e0eb12c chore(release): prepare 2.4.0, reconcileAvatarStorage(), MascotIconProps, MascotVariant, AvatarAccentPresentation, AvatarAccentRgb, assert, { deriveAvatarAccent, dominantAvatarColor } (+26 more)
...
Cohesion: 0.05
Nodes (62): isRoomEmbedded(), extractRoomId(), ApiRequestError, checkRoomExists(), postJson(), cancelRoomRecovery(), isCurrentRoomRecoveryEpoch(), notifyLiveKitDisconnected() (+54 more)
...
Cohesion: 0.05
Nodes (54): 08e3e13 Merge branch 'hotfix/2.2.1', 17edd27 feat(web): add lobby voice controls widget, 31409db style(web): restore dock device popover chrome, 397400d chore(release): bump version to 2.2.2, 3ce55ad fix(web): dedupe self avatar and drop count label in room list, 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 4e52553 Merge branch 'feature/composer-emoji-picker' into develop (+46 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (39): 10de220 test(api): prove active ban expiry in PostgreSQL, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 40320f3 fix(release): authenticate oci evidence producers, 6b3fc40 fix(release): require canonical merge commit authority, 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, 849600b fix(api): persist membership after admission, d8e3847 test(web): prove messaging reconciliation flows (+31 more)
...
Cohesion: 0.04
Nodes (35): 28a7a98 Merge branch 'feature/account-sessions-recovery' into develop, 3580978 fix(api): harden session and cookie write security, 9ca222c Merge branch 'feature/account-sessions-recovery' into develop, bf8c3cb fix(api): skip release announcements for accounts created after the release, eeb1235 feat(api): list and end account sessions, recover accounts by code, MMDB_METADATA_MARKER, now, previousMonth (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (2): 035114c Merge branch 'feature/chat-drafts' into develop, 355c86d feat(web): keep unsent chat text as a draft per chat
...
Cohesion: 0.04
Nodes (5): 0a0699b chore: release v2.1.2, 3b24424 fix(web): move download control to sidebar footer, 537a9a4 fix(web): auto-join room on direct load and reload, 95a5ce7 fix(web): keep chat-open stage layout when reopening room, e6df8d6 fix(web): show entered guest name in room chat
...
}, createAccountDeletionRepository(), crypto, PERSONAL_DATA_CLEANUP, { transaction }, { verifyPassword }, { ACCOUNT_DELETION_GRACE_MS }, assert (+27 more)
...
Cohesion: 0.06
Nodes (33): 1886650 feat(api): persist rooms and chat in postgres, 364b82c build(api): fence G15 predeploy migrations, path, readDatabaseConfig(), readEnvBool(), readEnvInt(), readMessageDeliveryMode(), { Pool } (+25 more)
...
Cohesion: 0.08
Nodes (23): emojiAssetName(), emojiAssetUrl(), 92c8df4 build(web): take emoji artwork from Discord's Twemoji release, e1ac1ca feat(web): draw emoji in messages as the same artwork as the picker, ea215d1 Merge branch 'feature/emoji-images' into develop, f63f951 Merge branch 'feature/composer-emoji-picker' into develop, assetName(), catalogueFile (+15 more)
...
Cohesion: 0.05
Nodes (3): 1578df6 feat: add account settings, cc7f297 Merge pull request: chore private monitoring agent, fe15e8b chore: add private monitoring agent

### Community 52 - "Community 52"
Cohesion: 0.10
Nodes (30): 2c5f8d4 feat(web): show stream quality on tile thumbnails, 4c756b6 Merge branch 'release/2.2.6', 7b8da98 feat(web): add the room music player, aaef77d fix(web): move stream metadata onto thumbnails, ca162ce build: ship music-bot as a published runtime image, ce89791 feat(web): add the room music player, df5ba40 feat(rooms): implement kick and ban moderation (#50), createPeerId() (+22 more)
...
Cohesion: 0.09
Nodes (24): 65f8383 chore: removed status agent file, 67b668e chore: merge v2.0.2 back to develop, b3728e3 feat: add guest name modal for room entry, b48e553 chore: release v2.0.2, RoomLifecycleSummary, cleanDisplayName(), applyRoomDeleted(), applyRoomNotFound() (+16 more)
...
Cohesion: 0.15
Nodes (19): 129387d feat(web): write messages in a field that shows emoji as artwork, dm, picker, reactors, room, store, summary, authDialog() (+11 more)
...
Cohesion: 0.08
Nodes (17): RealtimeHeartbeatWatchdog, PinsRealtimeEvent, ReactionRealtimeEvent, RealtimeAccountEvent, RealtimeErrorEvent, RealtimeHandle, RealtimeRoomEvent, RoomRealtimeSummary (+9 more)
...
Cohesion: 0.10
Nodes (26): 29612d4 fix(web): move room moderation into settings sections and popup menus, c2613dd fix(web): move room moderation into settings sections and popup menus (#124), d500d14 chore(release): back-merge 2.5.2 into develop, api, chat, component, lobby, members (+18 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (21): acquireMigrationLock(), advisoryLockParts(), assertMigrationLockHeld(), assertMigrationReady(), assertNoDirtyMigrationState(), ensureMigrationGuardSchema(), expectedMigrationCatalog(), MIGRATION_GUARD_STATES (+13 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (20): 0e0a5df Merge branch 'feature/2.6.0-prerelease' into develop, 2513c99 Merge branch 'feature/link-previews' into develop, 6f05892 feat(web): show link previews under chat messages, 800df39 Merge branch 'fix/api-test-db-teardown' into develop, 951412e chore(graphify): rebuild the knowledge graph for the test database teardown, a7a06b6 feat(web): show what is new as three short story slides, da34a66 test(api): let ended pools close before dropping a test database, WHATS_NEW_ITEMS (+12 more)
...
Cohesion: 0.13
Nodes (23): 09c4d42 feat(shared): add the room shared-music wire contract, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp, AVATAR_COLOR_KEY_SET, cleanAvatarColorKey(), cleanDisplayName(), cleanLiveKitUrl(), cleanName(), cleanPresenceStatus() (+15 more)

### Community 81 - "Community 81"
Cohesion: 0.14
Nodes (24): 253c24d feat(web): overlay avatar size and panel hints (#138), af5e82a feat(web): simpler overlay settings and stream state for the desktop HUD (#140), e2fe680 chore(release): back-merge 2.5.11 into develop, addDesktopOverlayGame(), DEFAULT_SETTINGS, desktopOverlayAvailable(), DesktopOverlayForeground, DesktopOverlayParticipant (+16 more)
...
Cohesion: 0.27
Nodes (13): 0b7bfc9 feat(web): add a desktop overlay for borderless games (#134), 1ae08e2 chore(release): back-merge 2.5.12 into develop, 3fa3f2e chore(release): back-merge 2.5.10 into develop, 7c03069 Merge pull request #141 from dazeGG/hotfix/2.5.12-backmerge, 929ba0d fix(web): desktop overlay avatars, custom games and idle opacity (#136), cad2af8 Merge pull request #137 from dazeGG/hotfix/2.5.10-backmerge, d43bbd4 Merge pull request #139 from dazeGG/hotfix/2.5.11-backmerge, ec272fa feat(web): add a desktop overlay for borderless games (#134) (#135) (+5 more)
...
Cohesion: 0.18
Nodes (8): 0d30394 chore: merge v2.1.1 back to develop, 0d74cad Merge branch 'release/2.1.6', 2eb2cbf chore: release v2.1.6, 4125bf0 Add desktop shell layout styles for Electron., 5cc251a chore: release v2.1.7, 5e9164c feat(web): align lobby preview tiles with room participant chrome, 98f910e Merge branch 'release/2.1.7', d16eace chore: merge hotfix/2.1.1 into main
...
Cohesion: 0.20
Nodes (1): 3f9d416 wip: discord-style redesign (spaces/channels)
...
Cohesion: 0.20
Nodes (7): assert, { createTestDatabase }, { createUserStore }, { LOGIN_ALERT_TTL_MS, LOGIN_FAMILIARITY_WINDOW_MS }, { runMigrations }, SILENT, test

### Community 169 - "Community 169"
Cohesion: 0.20
Nodes (9): assert, { createAttachmentRepository }, { createTestDatabase }, { createUserStore }, crypto, { Pool }, { runMigrations }, SILENT (+1 more)
...
Cohesion: 0.20
Nodes (8): assert, { AVATAR_COLOR_KEYS }, { createTestDatabase }, { createUserStore, publicUser }, crypto, { runMigrations }, SILENT, test
...
Cohesion: 0.33
Nodes (2): playbackPolicy, c948bb7 feat(notifications): add do not disturb settings (#53)
...
- **Thin community `Community 22`** (2 nodes): `035114c Merge branch 'feature/chat-drafts' into develop`, `355c86d feat(web): keep unsent chat text as a draft per chat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (1 nodes): `3f9d416 wip: discord-style redesign (spaces/channels)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 182`** (1 nodes): `lang`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 204`** (2 nodes): `playbackPolicy`, `c948bb7 feat(notifications): add do not disturb settings (#53)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 211`** (2 nodes): `participantContextMenu`, `ParticipantMenuVariant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 215`** (1 nodes): `FakeServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 226`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (2 nodes): `copyTextFor()`, `handleEmojiCopy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 229`** (1 nodes): `registerDmHistoryRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (1 nodes): `registerModerationRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (2 nodes): `extensions`, `files`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `RealtimeRecoveryController` connect `Community 47` to `Community 15`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AppRealtimeConnection` connect `Community 96` to `Community 66`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.05760443864229765 - nodes in this community are weakly interconnected._
