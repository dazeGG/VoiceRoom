...
## Corpus Check
- Large corpus: 790 files · ~385 445 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6348 nodes · 17746 edges · 232 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4768 · MODIFIES: 4462 · ON_BRANCH: 3632 · calls: 1940 · imports: 1157 · imports_from: 785 · PARENT_OF: 695 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1
...
- Excluded: 0 untracked · 46866 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `8c60e5d`
...
Cohesion: 0.05
Nodes (328): backup/room-shared-music-pre-rebase, chore/graphify-refresh, develop, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/account-sessions-recovery, feature/cd-pipeline, feature/composer-emoji-picker (+320 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (188): createFriendStore(), createMessageReadRepository(), registerPinRoutes(), {
  ACCOUNT_DELETION_GRACE_MS,
  WHATS_NEW_VERSION,
  formatRecoveryCode,
  isDeletedAccountLogin
}, { assertMigrationReady, runMigrations }, attachFastifyRequestBody(), AUTH_RATE_LIMIT, AUTH_RATE_WINDOW_MS (+180 more)
...
Cohesion: 0.02
Nodes (39): 2d36bc7 fix(api): bound messaging schema locks, 69b709a test(shared): correct platform DTO assertion, 728cea2 feat: implement release 2.5.0 messaging platform (#105), ab373a6 chore(release): 2.5.0 (#121), edf6daf test(api): prove platform class migration, { createDbPool }, createRelease250Pool(), createMediaQuotaRepository() (+31 more)
...
Cohesion: 0.04
Nodes (46): del(), fetchJson(), patchJson(), postJson(), postJsonAuth(), putJson(), createRoomProof(), hasLeadingZeroBits() (+38 more)
...
Cohesion: 0.03
Nodes (57): 1578df6 feat: add account settings, 208f295 feat(presence): add selectable account statuses, 22a796b Merge pull request #8 from feature/404-page, 3580978 fix(api): harden session and cookie write security, 4a8d9fc fix(api): address room persistence review findings, cc7f297 Merge pull request: chore private monitoring agent, ec9f802 feat(api): persist visual identity keys, ee1c6f6 feat(shared): add visual identity contracts (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (53): b16c894 fix(api): expose fail-closed release telemetry, fa382b2 fix(api): derive backlog age directly from storage, createDbPool(), { Pool }, { readDatabaseConfig }, { recordPgPoolError }, transaction(), { classifyPlatform, PLATFORM_CLASSES } (+45 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (39): AuthUser, playbackPolicy, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 2b2c6c9 chore: release v2.0.0 (+31 more)
...
Cohesion: 0.05
Nodes (15): AvatarProps, AvatarCropDialogProps, AvatarCropShape, BadgeProps, ButtonProps, 13148b1 style(web): apply canonical background palette, 1594fb0 feat(web): refine chat and room interactions, 3db468e feat(web): Volt redesign — landing, lobby v2, shared UI (#38) (+7 more)
...
Cohesion: 0.03
Nodes (50): createAttachmentRepository(), createTestDatabase(), crypto, databaseName(), databaseUrlFor(), { Pool }, quoteIdent(), { readDatabaseConfig } (+42 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (47): 53d093e test(api): execute hostile credential boundary scenarios, c02e107 fix(web): recover attachment compose safely, cc45703 fix(api): expose worker metrics across process boundaries, d37be0b feat(api): expose media pressure health, composer, dm, room, store (+39 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (45): 1709ead fix(api): centralize active room ban enforcement, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 501ef14 test(web): lock leave and rejoin flow, d9f484d test(engagement): prove content and mention UoW, ebd3ed4 test(release): define G50 membership checkpoint, membershipModel, routes, service (+37 more)
...
Cohesion: 0.03
Nodes (3): SelectedMention, 035114c Merge branch 'feature/chat-drafts' into develop, 355c86d feat(web): keep unsent chat text as a draft per chat

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (41): 05f2a77 test(api): bind strict credential cutover, 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, 849600b fix(api): persist membership after admission, 88169aa fix(api): preserve migration history with corrective follow-ups, model, assert, { createTestDatabase } (+33 more)
...
}, createAccountDeletionRepository(), crypto, PERSONAL_DATA_CLEANUP, { transaction }, { verifyPassword }, lang, 3258210 docs: describe account deletion and its grace period (+24 more)
...
Cohesion: 0.06
Nodes (41): 1886650 feat(api): persist rooms and chat in postgres, 364b82c build(api): fence G15 predeploy migrations, 8fdccbd chore(scripts): default to docker compose workflows, a36adca chore(docker): add postgres compose workflows, c928af9 fix(api): require exact migration catalog readiness, path, readDatabaseConfig(), readEnvBool() (+33 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (29): 2350242 build(api): define expiry-aware rescue profile, 29612d4 fix(web): move room moderation into settings sections and popup menus, 4ea02ee fix(api): harden temporary moderation flows, 7795005 test(web): cover moderation center contract, api, chat, component, lobby (+21 more)
...
Cohesion: 0.05
Nodes (38): 40320f3 fix(release): authenticate oci evidence producers, 6b3fc40 fix(release): require canonical merge commit authority, 7609180 fix(web): harden reaction convergence, 824382d test(release): define G71 engagement checkpoint, ac1c7f4 fix(api): allow safe guest reaction reads, ad596da test(api): prove reaction persistence invariants, ae1827c fix(reactions): converge updates across realtime clients, b541a05 test(api): resolve reaction fixtures from workspace (+30 more)
...
Cohesion: 0.07
Nodes (31): ComposerSelection, 017195e Merge branch 'feature/composer-emoji-picker' into develop, 3ea131d feat(shared): let typing notices say whether someone types or picks an emoji, 756d573 feat(web): add an emoji button to the message field and show emoji browsing, 8ffc3ac feat: show who is typing in direct messages and room chats, b5fc40e Merge branch 'feature/chat-typing' into develop, f338035 chore(graphify): rebuild the knowledge graph for the composer emoji picker, buildRoomRealtimeSummary() (+23 more)
...
Cohesion: 0.08
Nodes (30): 48b24e0 fix: room notifications for all members, desktop badge, unread for new members, b6c5445 fix(api): reuse account avatar color in calls, c6c3247 fix: room notifications for all members, desktop badge and unread for new members (#129), d6b1773 chore(release): back-merge 2.5.6 into develop, {
  AVATAR_COLOR_KEYS,
  cleanAvatarColorKey
}, avatarColorForPeerId(), { createActiveBanService }, { createDbPool, transaction } (+22 more)
...
Cohesion: 0.10
Nodes (40): authorizeRoomMutation(), broadcast(), broadcastRoomUpdate(), closePeer(), countRoomCreationQuotaRoomsForIp(), disconnectModeratedPeer(), expireRoomInvitations(), finalizeDueAccountDeletions() (+32 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (29): { buildServerEnvelope }, legacyPeerMessageToWs(), createTransportId(), createWsTransport(), crypto, { buildRoomRealtimeSummaryFromLobbyRoom, createSummaryCoalescer }, { buildServerEnvelope, buildServerErrorEnvelope }, clearViewedScreenPeerReferences() (+21 more)
...
Cohesion: 0.09
Nodes (33): 0ec8255 chore(release): bump version to 2.2.3, 17edd27 feat(web): add lobby voice controls widget, 2adaec0 Merge branch 'hotfix/2.2.3-ci', 397400d chore(release): bump version to 2.2.2, 3b6010b Merge branch 'release/2.2.2', 5fa984e Merge tag 'v2.2.2' into develop, bc6c32c Merge tag 'v2.2.3' into develop, cf119b8 fix(api): wait for fresh websocket summary frames (+25 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (28): 1595593 feat(notifications): add web push delivery (#51), 4977987 feat(rooms): add friend ring invitations (#52), 5d910ea fix(notifications): fail closed on provider errors, cleanPushEndpoint(), crypto, describePushEndpoint(), EXACT_PUSH_HOSTS, isAllowedPushHost() (+20 more)
...
Cohesion: 0.08
Nodes (24): 10de220 test(api): prove active ban expiry in PostgreSQL, 177f5e3 test(api): prove durable message delivery, 93cad8e test(release): define G42 messaging checkpoint, readEnvInt(), abortError(), boundedBackoff(), createLeaseRuntime(), crypto (+16 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (22): 20fdff5 feat(api): persist static rooms and chat, fs, net, startApiListener(), assert, fs, os, path (+14 more)
...
Cohesion: 0.10
Nodes (11): 2ea3623 Merge pull request #116 from dazeGG/feature/2.5.0-manual-fixes, c80ed8a feat(web): expand contextual menus, ContextMenuContentState, ContextMenuProps, ProfileCardAnchor, profileCardUi, ProfileCardPerson, ProfileCardProps (+3 more)
...
Cohesion: 0.09
Nodes (18): emojiAssetName(), emojiAssetUrl(), isToneIndex(), loadSkinTone(), saveSkinTone(), SkinToneIndex, cbaf1f5 Merge branch 'feature/2.5.0-fixes' into develop, assetName() (+10 more)
...
Cohesion: 0.11
Nodes (26): 09c4d42 feat(shared): add the room shared-music wire contract, 6eb964c feat(shared): add the room shared-music wire contract, a0fa2d6 feat(api): drive room shared-music sessions, eb7ef3a fix(web): avoid cjs validation import in ssr, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp, AVATAR_COLOR_KEY_SET, cleanAvatarColorKey(), cleanDisplayName() (+18 more)
...
Cohesion: 0.09
Nodes (21): 8c60e5d fix(api): deliver a typing activity switch instead of dropping it, createTypingThrottle(), { buildServerEnvelope, buildServerErrorEnvelope, parseInboundMessage }, { createTypingThrottle }, createWsHandler(), {
  normalizePeerId,
  normalizeRoomId,
  normalizeSessionToken
}, { normalizeTypingActivity }, assert (+13 more)
...
Cohesion: 0.08
Nodes (18): 166a0e8 test(release): resolve rescue fixtures from repository root, 5dd3691 test(api): serialize database suites, bf6bba7 test(api): cover media backlog age query, f540886 test(release): refresh CI gate fixtures, CONTEXTS, crypto, mapAttachment(), MIME_TYPES (+10 more)
...
Cohesion: 0.11
Nodes (18): 08e3e13 Merge branch 'hotfix/2.2.1', 31409db style(web): restore dock device popover chrome, 3ce55ad fix(web): dedupe self avatar and drop count label in room list, 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 52c6592 Merge tag 'v2.2.1' into develop, 6113243 chore(release): bump version to 2.1.11, 7524c15 feat(realtime): add websocket room updates (+10 more)
...
Cohesion: 0.09
Nodes (17): 88e8e93 test(release): define physical support matrix gate, b318c49 test(web): prove desktop root boundary, c4b1a22 test(api): enforce exact migration lock budget, BLOCKED_ROUTES, assert, { classifyPlatform }, { Client }, { createPushStore } (+9 more)
...
Cohesion: 0.11
Nodes (13): b8dccee fix(api): never expire or trim room chat history, e3e634d Merge branch 'fix/keep-room-chat-history' into develop, assert, { createTestDatabase }, fs, http, { openWs, joinVoiceRoom, subscribeRoomPreview, waitForWsType }, os (+5 more)
...
Cohesion: 0.13
Nodes (14): 8b9b619 feat(api): forward what a typist is doing in rooms and direct threads, d674618 refactor(web): move the emoji browser out of the reaction picker, assert, { countWsType, joinVoiceRoom, openWs, sendWs, subscribeRoomPreview, waitForWsType }, { createTestDatabase }, fs, http, os (+6 more)
...
Cohesion: 0.14
Nodes (14): attachPresence(), bootstrap(), createApiServer(), createRoomForRequest(), createRoomId(), getPresenceRoom(), getRoom(), handleRoomChatList() (+6 more)
...
Cohesion: 0.20
Nodes (9): 2ca6443 test(shared): lock platform classification contract, fdb6786 test(api): make G14 paths workspace-safe, assert, cjs, CORPUS, fs, path, { pathToFileURL } (+1 more)
...
Cohesion: 0.50
Nodes (3): getServer(), loadInsert(), webRoot
...
- **Thin community `Community 46`** (2 nodes): `3c617ec style(web): polish dm day separator`, `7db2783 docs(monitoring): align LiveKit track metric labels`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 173`** (1 nodes): `RealtimeHeartbeatWatchdog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 202`** (1 nodes): `LiveKitReconcileGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (2 nodes): `o`, `s()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 209`** (1 nodes): `FakeServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 226`** (2 nodes): `extensions`, `files`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (1 nodes): `MemoryStorage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 229`** (2 nodes): `VoiceRoom App Icon (Owl Mascot Mark on Dark Rounded Square)`, `VoiceRoom Mascot Mark (Masked Owl Silhouette, Transparent)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (1 nodes): `ADR: Unicode authority for message reactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (1 nodes): `VoiceRoom 2.5 Architecture Boundaries`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `Backlog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `config/capability-dag.v1.json`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (1 nodes): `Capability Readiness Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `Design QA — reusable room and chat menus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (1 nodes): `Font Assets README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 237`** (1 nodes): `LiveKit External Auth-Gate Operations Doc (G05)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `VoiceRoom monitoring agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `OCI Runtime Publication Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `packages/CLAUDE.md Guidance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (1 nodes): `Production Digest Promotion Doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (1 nodes): `Release 2.5.0 Repairs README`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `RealtimeRecoveryController` connect `Community 49` to `Community 9`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.05222693531283139 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.010845771144278607 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.03370049829530553 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02185792349726776 - nodes in this community are weakly interconnected._
