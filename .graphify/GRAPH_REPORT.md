...
## Corpus Check
- Large corpus: 805 files · ~396 636 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6475 nodes · 19967 edges · 236 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 5385 · contains: 4831 · MODIFIES: 4781 · calls: 1950 · imports: 1165 · imports_from: 793 · PARENT_OF: 755 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 805 · Candidates: 885
- Excluded: 0 untracked · 48405 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `97d6dcd`
...
Cohesion: 0.08
Nodes (190): develop, feature/2.6.0-prerelease, feature/composer-emoji-picker, feature/emoji-images, feature/whats-new-recovery-codes, feature/whats-new-screenshots, feature/whats-new-stories, fix/api-test-db-teardown (+182 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (185): createFriendStore(), createDirectMessageRepository(), createMessageReadRepository(), registerRoomHistoryRoutes(), createRoomMessageRepository(), registerNotificationRoutes(), {
  ACCOUNT_DELETION_GRACE_MS,
  WHATS_NEW_VERSION,
  formatRecoveryCode,
  isDeletedAccountLogin
}, { assertMigrationReady, runMigrations } (+177 more)

### Community 2 - "Community 2"
Cohesion: 0.10
Nodes (180): backup/room-shared-music-pre-rebase, chore/graphify-refresh, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/account-sessions-recovery, feature/cd-pipeline, feature/desktop-app-settings, feature/docs-cleanup (+172 more)
...
Cohesion: 0.03
Nodes (115): 234177e feat(web): redesign screen source picker, 269978f chore(release): bump version to 2.2.6, 4c756b6 Merge branch 'release/2.2.6', 9ba8ece feat(web): tune screen share encoding, f5501ff Merge tag 'v2.2.6' into develop, SCREEN_FPS_OPTIONS, SCREEN_QUALITY_OPTIONS, SCREEN_SIMULCAST_LAYER (+107 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (89): 7b8da98 feat(web): add the room music player, a0ff17a feat(web): improve sound settings with sliders and cue volume (#30), ca162ce build: ship music-bot as a published runtime image, ce89791 feat(web): add the room music player, MicrophoneMode, NOISE_MODES, NoiseMode, NoiseModeOption (+81 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (45): AuthUser, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 2b2c6c9 chore: release v2.0.0, 3580978 fix(api): harden session and cookie write security (+37 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (47): DesktopAsset, DesktopRelease, del(), fetchJson(), patchJson(), postJson(), postJsonAuth(), putJson() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (30): 4be8312 chore: release v2.1.0, 551c869 chore: merge v2.1.0 back to develop, 5eef100 feat: friends, direct messages, and social lobby (#19), b48e553 chore: release v2.0.2, b503e28 chore: merge release/2.1.0 into main, { cleanAvatarColorKey, cleanPresenceStatus }, { createDbPool, transaction }, crypto (+22 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (22): 0a0699b chore: release v2.1.2, 0a9be62 fix(web): keep room preview chat closed by default (#32), 0d30394 chore: merge v2.1.1 back to develop, 0f3d7a0 Merge branch 'hotfix/2.1.3', 0ffac54 feat(infra): expose livekit prometheus metrics for status stack (#22), 1840f18 chore: release v2.1.4, 2684b15 chore: release v2.1.3, 2994d09 fix(api): return friend request id from listRequests (+14 more)
...
Cohesion: 0.03
Nodes (57): 177f5e3 test(api): prove durable message delivery, 93cad8e test(release): define G42 messaging checkpoint, fa382b2 fix(api): derive backlog age directly from storage, readEnvInt(), { buildMessageDeliveryEvent }, createMessageOutboxRepository(), crypto, encodeParts() (+49 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (66): 72d40ae fix(web): drop empty-room placeholder, auto-join guests, isRoomEmbedded(), applySpeaking(), attachMeter(), isLocalMicrophoneSpeaking(), isOverSpeakingThreshold(), refreshMicrophoneLevelMeterSoon(), startMeters() (+58 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (47): ReadReconciliationOptions, 4553c35 fix(web): reconcile repeated cross-tab read cursors, 54086b4 fix(api): serialize notification retraction revisions, 8e66057 fix(ci): fail release gates on wrong branch, b3732be fix(notifications): make inbox revisions monotonic, fcd0beb fix(ci): bind OCI evidence to Actions archive bytes, model, router (+39 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (36): AvatarCropDialogProps, AvatarCropShape, AvatarStackItem, AvatarStackProps, 049a913 fix(web): keep popover open on ambiguous focus loss, 08bd491 fix(web): focus DM compose input when opening a friend chat (#28), 0c20745 chore(release): back-merge 2.1.9, 206a214 refactor(web): use shared slider in settings controls (+28 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (47): 043b73d chore: release v2.1.5, 0d74cad Merge branch 'release/2.1.6', 164b853 refactor(web): neutral input placeholders, dedicated dev port, desktop drag region (#16), 1a5009b fix(web): remove transient voice-connecting placeholder, 22a796b Merge pull request #8 from feature/404-page, 2c5f8d4 feat(web): show stream quality on tile thumbnails, 2ea67a2 Merge branch 'release/2.2.4', 2eb2cbf chore: release v2.1.6 (+39 more)
...
Cohesion: 0.04
Nodes (30): playbackPolicy, e0eb12c chore(release): prepare 2.4.0, ContextMenuContentState, ContextMenuProps, reconcileAvatarStorage(), MascotIconProps, MascotVariant, AvatarAccentPresentation (+22 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (43): b120355 feat(release): complete 2.4.0 plan (#55), eventMatchesHotkey(), getDefaultHotkeyBinding(), getHotkeyStorageKey(), HotkeyAction, isTypingTarget(), parseHotkeyBinding(), readHotkeyBinding() (+35 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (49): 13254ae docs: document durable room storage, 1886650 feat(api): persist rooms and chat in postgres, 8fdccbd chore(scripts): default to docker compose workflows, a36adca chore(docker): add postgres compose workflows, AVATAR_KEY_PATTERN, createAvatarStorage(), fs, path (+41 more)
...
Cohesion: 0.06
Nodes (16): AvatarProps, BadgeProps, ButtonProps, 2391bbe feat(web): migrate UI icons to Lucide (#42), 3db468e feat(web): Volt redesign — landing, lobby v2, shared UI (#38), 7dd4a5f refactor(rooms): replace visual presets with fallback avatars (#44), 89decba feat(web): improve active voice widget with room visual and leave cue, eb48d74 feat(web): adopt comfortaa and nunito typography (+8 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (10): c860746 feat(web): add static rooms and room chat UI, hasLeadingZeroBits(), waitForUi(), ApiRequestError, checkRoomExists(), fetchJson(), postJson(), createRoomProof() (+2 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (50): 08e3e13 Merge branch 'hotfix/2.2.1', 0ec8255 chore(release): bump version to 2.2.3, 17edd27 feat(web): add lobby voice controls widget, 2adaec0 Merge branch 'hotfix/2.2.3-ci', 397400d chore(release): bump version to 2.2.2, 3b6010b Merge branch 'release/2.2.2', 3ce55ad fix(web): dedupe self avatar and drop count label in room list, 52c6592 Merge tag 'v2.2.1' into develop (+42 more)
...
Cohesion: 0.06
Nodes (41): 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 7524c15 feat(realtime): add websocket room updates, beffc4f Merge tag 'v2.2.0' into develop, { buildServerEnvelope }, toWsAccountEvent(), {
  parseClientEnvelope,
  buildServerEnvelope,
  buildServerErrorEnvelope,
  validateClientCommand
}, sendWsEnvelope() (+33 more)
...
Cohesion: 0.06
Nodes (36): containsPath(), createCoordinatedSnapshot(), filesBelow(), resolvedProspectivePath(), sha256(), 06b943b fix(ops): bind media restore catalog, 1332815 feat(ops): add coordinated media restore, 166a0e8 test(release): resolve rescue fixtures from repository root (+28 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (14): ComposerSelection, copyTextFor(), handleEmojiCopy(), 5748635 Merge pull request #142 from dazeGG/release/2.6.0, MMDB_METADATA_MARKER, now, previousMonth, target (+6 more)
...
Cohesion: 0.08
Nodes (39): 09c4d42 feat(shared): add the room shared-music wire contract, ee1c6f6 feat(shared): add visual identity contracts, buildRoomRealtimeSummary(), buildServerEnvelope(), isPlainObject(), KNOWN_CLIENT_TYPES, { normalizeRoomId, normalizePeerId, normalizeSessionToken, cleanName }, normalizeTypingActivity() (+31 more)
...
Cohesion: 0.05
Nodes (30): da2ffb3 fix(release): stabilize G01-G03 foundation gates (#112), extensions, files, assert, { createTestDatabase }, fs, http, os (+22 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (31): 1578df6 feat: add account settings, cc7f297 Merge pull request: chore private monitoring agent, fe15e8b chore: add private monitoring agent, { AVATAR_COLOR_KEYS, cleanAvatarColorKey, cleanPresenceStatus }, { createDbPool, transaction }, createUserStore(), crypto, { hashPassword, verifyPassword } (+23 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (24): a0fa2d6 feat(api): drive room shared-music sessions, d523ff1 chore(release): back-merge 2.6.0 into develop, edcdda0 feat(music-bot): add the shared-music bot backed by yt-dlp, parseInboundMessage(), createTypingThrottle(), { buildServerEnvelope, buildServerErrorEnvelope, parseInboundMessage }, { createTypingThrottle }, createWsHandler() (+16 more)
...
Cohesion: 0.07
Nodes (32): clean(), decodeEntities(), decodeHtmlBody(), extractLinkPreviewMetadata(), NAMED_ENTITIES, parseAttributes(), resolveHttpUrl(), createLinkPreviewRepository() (+24 more)
...
Cohesion: 0.07
Nodes (26): assert, { createTestDatabase }, { createUserStore }, { LOGIN_ALERT_TTL_MS, LOGIN_FAMILIARITY_WINDOW_MS }, { runMigrations }, SILENT, test, createTestDatabase() (+18 more)
...
Cohesion: 0.08
Nodes (28): fetchReactionSummaries(), fetchReactors(), ReactionConversation, reactionUrl(), setReactionDesired(), validSummaries(), ReactionSnapshotView, replaceReactionSnapshot() (+20 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (22): 1709ead fix(api): centralize active room ban enforcement, 88e8e93 test(release): define physical support matrix gate, b318c49 test(web): prove desktop root boundary, c4b1a22 test(api): enforce exact migration lock budget, BLOCKED_ROUTES, createActiveBanRepository(), crypto, mapActiveBan() (+14 more)
...
Cohesion: 0.09
Nodes (29): bcdcd06 refactor(web): untangle room client import cycles, df5ba40 feat(rooms): implement kick and ban moderation (#50), createPeerId(), createSessionToken(), extractRoomId(), getRoomIdFromPath(), getStoredPeerSession(), rotateStoredPeerSession() (+21 more)
...
Cohesion: 0.10
Nodes (22): 5d910ea fix(notifications): fail closed on provider errors, cleanPushEndpoint(), crypto, describePushEndpoint(), EXACT_PUSH_HOSTS, isAllowedPushHost(), { cleanPushEndpoint, describePushEndpoint }, createPushService() (+14 more)
...
Cohesion: 0.12
Nodes (23): 97d6dcd fix(web): stop showing idle push-to-talk as a muted microphone, isMicrophoneShownMuted(), persistMicrophoneMode(), persistOutputMuted(), hasLocalScreenAudio(), postState(), supportsAudioOutputSelection(), beginPushToTalk() (+15 more)
...
Cohesion: 0.13
Nodes (14): 28759aa fix(web): stack room reactions and keep the message toolbar reachable, 331bb32 fix(web): restore room panel interaction, 5137885 fix(api): guard room removal and muted joins, 611153a test(web): anchor the DM polish e2e on the message row id, 647c18f fix(web): make chat replies jumpable and message identity clickable, 6baa520 Merge pull request #119 from dazeGG/feature/2.5.0-chat-polish, 732ab15 fix(api): keep room chat history instead of expiring it, 8d84b9b fix(web): unify room and profile menus (+6 more)
...
Cohesion: 0.12
Nodes (11): emojiAssetName(), emojiAssetUrl(), 1051d9c fix(web): make the speaking ring report who is actually audible, 42e581f feat(web): draw reactions from bundled artwork and rebuild the picker, 690fee9 build(web): keep the emoji artwork source out of the runtime images, be4b55b feat(shared): collapse reaction emoji skin tones behind their base, cbaf1f5 Merge branch 'feature/2.5.0-fixes' into develop, ea215d1 Merge branch 'feature/emoji-images' into develop (+3 more)
...
Cohesion: 0.11
Nodes (11): 20fdff5 feat(api): persist static rooms and chat, assert, { createTestDatabase }, fs, http, { openWs, joinVoiceRoom }, os, path (+3 more)
...
Cohesion: 0.16
Nodes (9): 0b4c646 feat(platform): enforce G14 capability readiness, 364b82c build(api): fence G15 predeploy migrations, 5459a43 feat(platform): harden G13 runtime configuration edge, 924295b test(web): prove G13 against pinned Caddy, a37d685 test(web): make G13 paths workspace-safe, d5ce547 test(release): validate frozen budgets, ecc157a refactor(web): preserve async failure evidence, f5c42a7 test(release): prepare fail-closed rc preflight (+1 more)
...
Cohesion: 0.29
Nodes (8): 1b46251 fix(web): fit the image viewer, tighten the picker, ping on mention only, 2bb0df7 feat(web): give images a real viewer, and open pending ones in it, 84ba47a feat(web): rebuild the notification centre, and retire notifications on read, 9c1c7df Merge branch 'feature/2.5.0-fixes' into develop, a0dac33 Merge branch 'feature/2.5.0-fixes' into develop, c22c49a Merge branch 'feature/2.5.0-fixes' into develop, webRoot, webRoot
...
Cohesion: 0.24
Nodes (11): 50f75e7 Merge branch 'release/2.2.8', 66d2bdd feat(web): apply screen profile via desktop capture bridge, 67827fd Merge branch 'release/2.2.7', 81b047c Merge tag 'v2.2.8' into develop, 8482221 chore(release): bump version to 2.2.8, 91c57c5 fix(web): truncate long room names in lobby, ba3d0d2 Merge tag 'v2.2.7' into develop, bd9bc6c feat(web): add native capture stats to screen share monitoring (+3 more)
...
Cohesion: 0.33
Nodes (6): importTypeScript(), read(), readPreviewChat(), readRoomChat(), readTree(), readTreeFiles()
...
Cohesion: 0.40
Nodes (5): 0753576 fix(web): show avatars in stream placeholders, 1ddbd67 fix(web): show viewer avatars in stream badge, 5b54d09 fix(web): remove viewer label from stream badge, 6ea473b docs: add git flow workflow, b944a1b Revert "fix(web): show avatars in stream placeholders"
...
Cohesion: 0.40
Nodes (5): 2008ab4 feat(web): standardize interactive control sizing (#40), 7d84f79 fix(web): center interactive control labels (#41), 87a32c5 test(web): update volt redesign ui contracts, a0cef2c chore(release): bump version to 2.3.1, a674c7c chore(release): bump version to 2.3.0
...
Cohesion: 0.50
Nodes (4): 2ce6059 test(shared): lock attachment contracts, 824382d test(release): define G71 engagement checkpoint, b541a05 test(api): resolve reaction fixtures from workspace, c1f8e3c test(web): bind account-only reaction picker
...
Cohesion: 0.67
Nodes (3): 96d279a fix(web): use account color for local room avatar, a8fe4de chore(release): bump version to 2.2.4, e46d1a5 fix(web): align embedded room top spacing

### Community 235 - "Community 235"
Cohesion: 0.67
Nodes (3): assertSupportedFontWeights(), fontFamiliesByRole(), fontRangesByFamily()

### Community 236 - "Community 236"
Cohesion: 1.00
Nodes (2): a3f35c0 fix(web): keep self tile when muting, a864b9c fix(web): highlight active speaker tiles
...
- **Thin community `Community 181`** (1 nodes): `lang`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 206`** (1 nodes): `LiveKitReconcileGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (2 nodes): `o`, `s()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (2 nodes): `participantContextMenu`, `ParticipantMenuVariant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 223`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 228`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (1 nodes): `registerDmHistoryRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `registerModerationRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `root`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (2 nodes): `a3f35c0 fix(web): keep self tile when muting`, `a864b9c fix(web): highlight active speaker tiles`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `RealtimeRecoveryController` connect `Community 51` to `Community 12`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AppRealtimeConnection` connect `Community 93` to `Community 68`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.08169364881693648 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.010576644450883802 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.1042386185243328 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02125375697724345 - nodes in this community are weakly interconnected._