...
## Corpus Check
- Large corpus: 798 files · ~390 165 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6418 nodes · 18361 edges · 242 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4811 · MODIFIES: 4577 · ON_BRANCH: 4060 · calls: 1945 · imports: 1158 · imports_from: 786 · PARENT_OF: 717 · method: 208 · re_exports: 59 · references: 23 · inherits: 10 · conceptually_related_to: 4 · semantically_similar_to: 2 · implements: 1
...
- Excluded: 1 untracked · 48107 ignored · 13 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `522a3e8`
...
Cohesion: 0.05
Nodes (343): backup/room-shared-music-pre-rebase, chore/graphify-refresh, develop, feature/2.5.0-manual-fixes, feature/2.5.0-to-rc, feature/2.6.0-prerelease, feature/account-sessions-recovery, feature/cd-pipeline (+335 more)
...
Cohesion: 0.03
Nodes (152): 0d74cad Merge branch 'release/2.1.6', 1a5009b fix(web): remove transient voice-connecting placeholder, 72d40ae fix(web): drop empty-room placeholder, auto-join guests, 8b5b175 chore: merge v2.0.1 back to develop, cef76ec chore: release v2.0.1, e9dccb2 fix(web): recover remote microphone playback, clearPeerJoinCue(), ApiRequestError (+144 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (130): 234177e feat(web): redesign screen source picker, 269978f chore(release): bump version to 2.2.6, 4c756b6 Merge branch 'release/2.2.6', 9ba8ece feat(web): tune screen share encoding, SCREEN_FPS_OPTIONS, SCREEN_QUALITY_OPTIONS, SCREEN_SIMULCAST_LAYER, SCREEN_STREAM_MODE_PROFILES (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (56): del(), fetchJson(), patchJson(), postJson(), postJsonAuth(), putJson(), createRoomProof(), hasLeadingZeroBits() (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (53): copyTextFor(), handleEmojiCopy(), SelectedMention, 2d36bc7 fix(api): bound messaging schema locks, 3593d1b chore(graphify): rebuild the knowledge graph for emoji copy, 522a3e8 Merge branch 'feature/emoji-images' into develop, 728cea2 feat: implement release 2.5.0 messaging platform (#105), 837c071 fix(web): copy emoji drawn as artwork as their characters (+45 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (91): 1578df6 feat: add account settings, 7b8da98 feat(web): add the room music player, 9c3b5e4 feat(audio): add unified playback bus (#54), a0ff17a feat(web): improve sound settings with sliders and cue volume (#30), ca162ce build: ship music-bot as a published runtime image, cc7f297 Merge pull request: chore private monitoring agent, ce89791 feat(web): add the room music player, fe15e8b chore: add private monitoring agent (+83 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (52): 043b73d chore: release v2.1.5, 0d30394 chore: merge v2.1.1 back to develop, 0f3d7a0 Merge branch 'hotfix/2.1.3', 0ffac54 feat(infra): expose livekit prometheus metrics for status stack (#22), 164b853 refactor(web): neutral input placeholders, dedicated dev port, desktop drag region (#16), 1840f18 chore: release v2.1.4, 22a796b Merge pull request #8 from feature/404-page, 2684b15 chore: release v2.1.3 (+44 more)
...
Cohesion: 0.04
Nodes (39): 28a7a98 Merge branch 'feature/account-sessions-recovery' into develop, 9ca222c Merge branch 'feature/account-sessions-recovery' into develop, bf8c3cb fix(api): skip release announcements for accounts created after the release, eeb1235 feat(api): list and end account sessions, recover accounts by code, MMDB_METADATA_MARKER, now, previousMonth, target (+31 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (56): bcdcd06 refactor(web): untangle room client import cycles, clampStreamVolume(), normalizeStoredStreamVolume(), storeStreamVolume(), RoomLifecycleSummary, Participant, clearScreenAttendance(), setScreenAttendance() (+48 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (57): dbToAmplitude(), persistMicrophoneVolume(), MicProcessor, MicrophoneCapture, applySpeaking(), attachMeter(), isLocalMicrophoneSpeaking(), isOverSpeakingThreshold() (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (36): RoomRealtimeSummary, RoomPeer, AvatarStackItem, AvatarStackProps, 049a913 fix(web): keep popover open on ambiguous focus loss, 0a9be62 fix(web): keep room preview chat closed by default (#32), 0c20745 chore(release): back-merge 2.1.9, 206a214 refactor(web): use shared slider in settings controls (+28 more)
...
Cohesion: 0.04
Nodes (38): ReadReconciliationOptions, 19902ab feat: prepare 2.5.0 RC and polish chats (#114), 4553c35 fix(web): reconcile repeated cross-tab read cursors, 8e66057 fix(ci): fail release gates on wrong branch, b3732be fix(notifications): make inbox revisions monotonic, d8e3847 test(web): prove messaging reconciliation flows, fcd0beb fix(ci): bind OCI evidence to Actions archive bytes, model (+30 more)
...
Cohesion: 0.05
Nodes (19): flipPlacementVertical(), parsePlacement(), resolvePopoverPlacement(), viewportSpaceAroundTrigger(), PlacementAxis, PopoverCloseReason, PopoverContentState, PopoverDividerProps (+11 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (46): 017195e Merge branch 'feature/composer-emoji-picker' into develop, 08e3e13 Merge branch 'hotfix/2.2.1', 17edd27 feat(web): add lobby voice controls widget, 397400d chore(release): bump version to 2.2.2, 3ce55ad fix(web): dedupe self avatar and drop count label in room list, 3f83f05 Merge branch 'release/2.2.0', 4cfb160 chore(release): bump version to 2.2.0, 4e52553 Merge branch 'feature/composer-emoji-picker' into develop (+38 more)
...
Cohesion: 0.05
Nodes (26): 15e3ea9 Merge branch 'feature/account-sessions-recovery' into develop, 51b04d8 Merge branch 'feature/account-sessions-recovery' into develop, 8a43888 feat: split what's new from the recovery codes reminder, 9b710c5 feat(web): change the password from the security tab, cb75953 Merge branch 'feature/new-login-alerts' into develop, ffc3589 feat: ask the account about sign-ins from new devices, WHATS_NEW_ITEMS, WhatsNewIcon (+18 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (44): createPushStore(), assert, { createTestDatabase }, { createUserStore }, { LOGIN_ALERT_TTL_MS, LOGIN_FAMILIARITY_WINDOW_MS }, { runMigrations }, SILENT, test (+36 more)
...
Cohesion: 0.04
Nodes (35): 40320f3 fix(release): authenticate oci evidence producers, 54086b4 fix(api): serialize notification retraction revisions, 6b3fc40 fix(release): require canonical merge commit authority, 74df7a9 fix(api): revoke only failed admission credential, 760fdfe fix(api): remediate oversized attachments before validation, transaction(), { createDbPool, transaction }, createMessageReadRepository() (+27 more)
...
Cohesion: 0.05
Nodes (37): 2ce6059 test(shared): lock attachment contracts, 7609180 fix(web): harden reaction convergence, 824382d test(release): define G71 engagement checkpoint, ac1c7f4 fix(api): allow safe guest reaction reads, ad596da test(api): prove reaction persistence invariants, ae1827c fix(reactions): converge updates across realtime clients, b541a05 test(api): resolve reaction fixtures from workspace, c1f8e3c test(web): bind account-only reaction picker (+29 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (41): 09c4d42 feat(shared): add the room shared-music wire contract, 6eb964c feat(shared): add the room shared-music wire contract, 7dd4a5f refactor(rooms): replace visual presets with fallback avatars (#44), ee1c6f6 feat(shared): add visual identity contracts, buildRoomRealtimeSummary(), buildServerEnvelope(), isPlainObject(), KNOWN_CLIENT_TYPES (+33 more)
...
Cohesion: 0.06
Nodes (5): 6c02eed feat(web): draw emoji in names and room names as artwork, ea215d1 Merge branch 'feature/emoji-images' into develop, eb48d74 feat(web): adopt comfortaa and nunito typography, NAME_SITES, webRoot
...
Cohesion: 0.08
Nodes (30): 48b24e0 fix: room notifications for all members, desktop badge, unread for new members, b6c5445 fix(api): reuse account avatar color in calls, c6c3247 fix: room notifications for all members, desktop badge and unread for new members (#129), d6b1773 chore(release): back-merge 2.5.6 into develop, ec9f802 feat(api): persist visual identity keys, {
  AVATAR_COLOR_KEYS,
  cleanAvatarColorKey
}, avatarColorForPeerId(), { createActiveBanService } (+22 more)
...
Cohesion: 0.06
Nodes (18): DesktopAsset, DesktopRelease, 634b607 feat(web): prepare Voice Room 1.7.0, hasLeadingZeroBits(), waitForUi(), DESKTOP_BUILDS, DesktopBuild, fetchJson() (+10 more)
...
Cohesion: 0.09
Nodes (16): AuthUser, roomNameFor(), clearSession(), session, setUser(), syncRoomName(), 2b2c6c9 chore: release v2.0.0, 59d8617 feat(web): add authenticated lobby and room chat v2 (+8 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (4): 0a0699b chore: release v2.1.2, 3b24424 fix(web): move download control to sidebar footer, 537a9a4 fix(web): auto-join room on direct load and reload, 95a5ce7 fix(web): keep chat-open stage layout when reopening room

### Community 46 - "Community 46"
Cohesion: 0.08
Nodes (29): c928af9 fix(api): require exact migration catalog readiness, d02ad7f fix(release): resolve evidence from immutable external artifacts, acquireMigrationLock(), advisoryLockParts(), assertMigrationLockHeld(), assertMigrationReady(), assertNoDirtyMigrationState(), { Client } (+21 more)
...
Cohesion: 0.07
Nodes (23): playbackPolicy, c948bb7 feat(notifications): add do not disturb settings (#53), df5ba40 feat(rooms): implement kick and ban moderation (#50), { buildServerEnvelope }, toWsAccountEvent(), { buildServerEnvelope }, legacyPeerMessageToWs(), buildRoomMembershipPresenceSnapshot() (+15 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (25): wait(), clearAllPeerJoinCues(), clearStreamViewerCues(), CueNote, getCueGain(), isCuePlaybackSuppressed(), peerJoinCueTimes, playCueSequence() (+17 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (25): 1709ead fix(api): centralize active room ban enforcement, createActiveBanRepository(), crypto, mapActiveBan(), normalizePrincipal(), toMillis(), { createActiveBanRepository, normalizePrincipal }, createActiveBanService() (+17 more)
...
Cohesion: 0.09
Nodes (27): createPeerId(), createSessionToken(), extractRoomId(), getRoomIdFromPath(), getStoredPeerSession(), rotateStoredPeerSession(), persistMicrophoneMode(), persistOutputMuted() (+19 more)
...
Cohesion: 0.06
Nodes (30): c15dee6 feat(api): attach link previews to room and direct messages, createLinkPreviewRepository(), assert, { createTestDatabase }, fs, get(), http, os (+22 more)
...
Cohesion: 0.08
Nodes (11): e0eb12c chore(release): prepare 2.4.0, ContextMenuContentState, ContextMenuProps, MascotIconProps, MascotVariant, root, root, ChatSegment (+3 more)
...
Cohesion: 0.07
Nodes (24): 8ffc3ac feat: show who is typing in direct messages and room chats, b5fc40e Merge branch 'feature/chat-typing' into develop, ClientEnvelope, RoomPeerSummary, RoomRealtimeSummary, RoomTypist, ServerEnvelope, TypingActivity (+16 more)
...
Cohesion: 0.11
Nodes (19): 2513c99 Merge branch 'feature/link-previews' into develop, 6f05892 feat(web): show link previews under chat messages, clean(), decodeEntities(), decodeHtmlBody(), extractLinkPreviewMetadata(), NAMED_ENTITIES, parseAttributes() (+11 more)
...
Cohesion: 0.14
Nodes (20): containsPath(), createCoordinatedSnapshot(), filesBelow(), resolvedProspectivePath(), sha256(), 06b943b fix(ops): bind media restore catalog, 1332815 feat(ops): add coordinated media restore, 94552a2 test(release): fail closed at develop entry (+12 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (11): ComposerSelection, PLURAL_VERB, SINGLE_VERB, TYPING_ACTIVITIES, TypingActivity, TypingEntry, TypingPerson, 756d573 feat(web): add an emoji button to the message field and show emoji browsing (+3 more)
...
Cohesion: 0.14
Nodes (24): 3fa3f2e chore(release): back-merge 2.5.10 into develop, cad2af8 Merge pull request #137 from dazeGG/hotfix/2.5.10-backmerge, ec272fa feat(web): add a desktop overlay for borderless games (#134) (#135), addDesktopOverlayGame(), DEFAULT_SETTINGS, desktopOverlayAvailable(), DesktopOverlayForeground, DesktopOverlayParticipant (+16 more)
...
Cohesion: 0.09
Nodes (16): 5d709c6 feat: add open-app push notifications (#43), assert, automaticPresenceMigration, avatarMigration, dndMigration, friendsMigration, membershipMigration, messageEditingMigration (+8 more)
...
Cohesion: 0.09
Nodes (14): createApiServer(), assert, { createApiApp, createApiServer }, { PUBLIC_CAPABILITY_KEYS }, { resetMetricsForTest }, test, assert, { bootstrap, createApiServer } (+6 more)
...
Cohesion: 0.12
Nodes (10): ChatMessage, ProfileCardAnchor, profileCardUi, ProfileCardPerson, ProfileCardProps, ProfileCardRelationship, mentionProfilePerson(), participantProfilePerson() (+2 more)

### Community 89 - "Community 89"
Cohesion: 0.10
Nodes (15): 01a206a chore: release v2.1.1, b8dccee fix(api): never expire or trim room chat history, cce23b6 fix(web): stabilize preview chat identity, e3e634d Merge branch 'fix/keep-room-chat-history' into develop, assert, { createTestDatabase }, fs, http (+7 more)

### Community 90 - "Community 90"
Cohesion: 0.11
Nodes (11): getAllParticipants(), getParticipantById(), FullscreenView, getActiveScreenPeer(), getScreenMetaView(), getScreenViewers(), getStreamVolumeView(), ScreenMetaView (+3 more)

### Community 91 - "Community 91"
Cohesion: 0.12
Nodes (12): AvatarCropDialogProps, AvatarCropShape, 6584f79 feat: add uploaded avatars for users and rooms (#45), reconcileAvatarStorage(), AvatarAccentPresentation, AvatarAccentRgb, assert, { deriveAvatarAccent, dominantAvatarColor } (+4 more)

### Community 92 - "Community 92"
Cohesion: 0.10
Nodes (6): 08bd491 fix(web): focus DM compose input when opening a friend chat (#28), 3940c26 fix(web): preserve friend online status across realtime race (#27), 98f910e Merge branch 'release/2.1.7', a6e2011 Merge branch 'release/2.1.8', b2b11a7 chore: release v2.1.8, e488265 fix(room): apply local participant voice volume reliably
...
Cohesion: 0.13
Nodes (16): path, readEnvBool(), readEnvInt(), readMessageDeliveryMode(), readUploadsDir(), createLinkPreviewStorage(), crypto, fs (+8 more)
...
Cohesion: 0.12
Nodes (15): createCapabilitySnapshot(), formatCapabilityPayload(), HEALTH_CAPABILITIES_LIMITS, { PUBLIC_CAPABILITY_KEYS }, publicFeatureFlags(), registerCapabilityRoutes(), assert, { createCapabilitySnapshot } (+7 more)
...
Cohesion: 0.11
Nodes (14): hashSessionToken(), publicUser(), assert, { AVATAR_COLOR_KEYS }, { createTestDatabase }, { createUserStore, publicUser }, crypto, { runMigrations } (+6 more)
...
Cohesion: 0.13
Nodes (10): 4a8d9fc fix(api): address room persistence review findings, a5a9bf8 chore(dev): update docker workflow docs, assert, { createRoomStore }, { createTestDatabase }, { createUserStore }, crypto, { Pool } (+2 more)
...
Cohesion: 0.15
Nodes (10): 0b4c646 feat(platform): enforce G14 capability readiness, 364b82c build(api): fence G15 predeploy migrations, 5459a43 feat(platform): harden G13 runtime configuration edge, 924295b test(web): prove G13 against pinned Caddy, a37d685 test(web): make G13 paths workspace-safe, d5ce547 test(release): validate frozen budgets, ecc157a refactor(web): preserve async failure evidence, f5c42a7 test(release): prepare fail-closed rc preflight (+2 more)

### Community 130 - "Community 130"
Cohesion: 0.16
Nodes (11): 1886650 feat(api): persist rooms and chat in postgres, a36adca chore(docker): add postgres compose workflows, readDatabaseConfig(), { Pool }, { readDatabaseConfig }, { recordPgPoolError }, main(), parseArgs() (+3 more)
...
Cohesion: 0.18
Nodes (6): assert, {createInboxRepository}, {createTestDatabase}, {Pool}, {runMigrations}, test
...
Cohesion: 0.20
Nodes (6): loadScreenAudioControls(), moduleUrl(), require, root, TestMediaStream, ts
...
Cohesion: 0.33
Nodes (7): 02d78bc Merge pull request #69 from dazeGG/hotfix/2.4.2-backmerge, 6cd4b30 fix(web): stabilize screen sharing in 2.4.2 (#68), cf1ea14 chore(release): back-merge 2.4.2 into develop, getScreenPublicationPresence(), ScreenPublicationPresence, getScreenReceiverDemand(), ScreenReceiverDemand

### Community 169 - "Community 169"
Cohesion: 0.38
Nodes (9): 1ae08e2 chore(release): back-merge 2.5.12 into develop, 253c24d feat(web): overlay avatar size and panel hints (#138), 7c03069 Merge pull request #141 from dazeGG/hotfix/2.5.12-backmerge, af5e82a feat(web): simpler overlay settings and stream state for the desktop HUD (#140), d43bbd4 Merge pull request #139 from dazeGG/hotfix/2.5.11-backmerge, e2fe680 chore(release): back-merge 2.5.11 into develop, getServer(), loadService() (+1 more)
...
Cohesion: 0.31
Nodes (6): markChatRead(), openChat(), RoomPanelTab, roomUi, selectRoomPanel(), toggleChat()
...
Cohesion: 0.33
Nodes (5): loadParticipantScreenLifecycle(), moduleUrl(), require, root, ts
...
Cohesion: 0.33
Nodes (5): createScreenSubscriptionRetryController(), SCREEN_SUBSCRIPTION_RETRY_DELAYS_MS, ScreenSubscriptionRetryScheduler, ScreenSubscriptionRetryState, ScreenSubscriptionRetryTarget
...
Cohesion: 0.50
Nodes (4): 0b7bfc9 feat(web): add a desktop overlay for borderless games (#134), 929ba0d fix(web): desktop overlay avatars, custom games and idle opacity (#136), edf009e feat(web): add desktop autostart settings, Window
...
- **Thin community `Community 101`** (2 nodes): `13254ae docs: document durable room storage`, `c860746 feat(web): add static rooms and room chat UI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (1 nodes): `ScreenRecoveryGraceController`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (1 nodes): `RealtimeHeartbeatWatchdog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (2 nodes): `require`, `ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (1 nodes): `TestMediaStream`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 218`** (1 nodes): `LiveKitReconcileGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (2 nodes): `o`, `s()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (2 nodes): `applyRoomSwitchDecision()`, `writeRoomSwitchConfirmEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (1 nodes): `VoiceRoomDesktopAudioSourceProcessor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `FakeSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (2 nodes): `129387d feat(web): write messages in a field that shows emoji as artwork`, `webRoot`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `registerDmHistoryRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `registerModerationRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (2 nodes): `extensions`, `files`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `RealtimeRecoveryController` connect `Community 43` to `Community 2`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.05045378023619356 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.010571884256094783 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.030084409494264483 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.028478142572102304 - nodes in this community are weakly interconnected._
- **Should `Community 4` be split into smaller, more focused modules?**
  _Cohesion score 0.01861124232404346 - nodes in this community are weakly interconnected._