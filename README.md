...
- Закреплённые сообщения в комнате: любой участник с аккаунтом закрепляет и открепляет сообщение, панель «Закреплённые» над чатом ведёт к нему по клику. До `50` закреплений на комнату, изменения приходят в realtime. В личных сообщениях закреплений нет.
