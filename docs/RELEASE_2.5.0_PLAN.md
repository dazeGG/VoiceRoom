...
- **Read-only literal paths:** `docs/ADR_LIVEKIT_CREDENTIAL_BOUNDARY.md`; `config/livekit/credential-boundary.v1.json`; `config/livekit/external-auth-gate.v1.json`; `apps/api/src/migrations/20260718130000_create_room_credential_epochs.js`; `apps/api/src/domains/moderation/active-ban-service.js`; `docker-compose.lkv.yml`.
